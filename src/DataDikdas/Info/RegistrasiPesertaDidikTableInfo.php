...
class RegistrasiPesertaDidikTableInfo extends base\BaseRegistrasiPesertaDidikTableInfo
{
    ...
    public function setVariables() {
        ...
        $this->moveColumnBelow($this->getColumnByName('no_peserta_ujian'), $this->getColumnByName('sekolah_asal'));
        ...
        $this->moveColumnBelow($this->getColumnByName('id_hobby'), $this->getColumnByName('no_skhun'));
        $this->moveColumnBelow($this->getColumnByName('id_cita'), $this->getColumnByName('id_hobby'));


        $fieldSet = new \DataDikdas\FieldsetInfo();
        $this->addRange('jurusan_sp_id', 'sekolah_asal', $fieldSet, 'Pendaftaran Masuk');
        ...
        $this->getColumnByName('a_pernah_paud')->setXtype('hidden');
        $this->getColumnByName('a_pernah_tk')->setXtype('hidden');
