...
class PesertaDidikTableInfo extends base\BasePesertaDidikTableInfo
{
    ...
    public function setVariables() {
        ...
        $this->moveColumnBelow($this->getColumnByName('nm_kip'), $this->getColumnByName('no_kip'));
        ...
        // $this->getColumnByName('lintang')->setDecimalPrecision(7);
        $this->getColumnByName('lintang')->setFormTextAlignRight(1);
        // $this->getColumnByName('lintang')->setDisabled(1);
        ...
        // $this->getColumnByName('bujur')->setDecimalPrecision(7);
        $this->getColumnByName('bujur')->setFormTextAlignRight(1);
        // $this->getColumnByName('bujur')->setDisabled(1);
        ...
        $this->getColumnByName('nama_ayah')->setLabel('Nama');
        $this->getColumnByName('tahun_lahir_ayah')->setLabel('Tahun lahir');
        ...
        $this->getColumnByName('jenjang_pendidikan_ayah')->setLabel('Pendidikan');
        $this->getColumnByName('pekerjaan_id_ayah')->setLabel('Pekerjaan');
        $this->getColumnByName('penghasilan_id_ayah')->setLabel('Penghasilan');
        $this->getColumnByName('kebutuhan_khusus_id_ayah')->setLabel('Berkebutuhan khusus');
        ...
        $this->getColumnByName('nama_ibu_kandung')->setLabel('Nama');
        $this->getColumnByName('tahun_lahir_ibu')->setLabel('Tahun lahir');
        ...
        $this->getColumnByName('pekerjaan_id_ibu')->setLabel('Pekerjaan');
        $this->getColumnByName('penghasilan_id_ibu')->setLabel('Penghasilan');
        $this->getColumnByName('pekerjaan_id_ibu')->setAllowEmpty(0);
        $this->getColumnByName('penghasilan_id_ibu')->setAllowEmpty(0);
        $this->getColumnByName('kebutuhan_khusus_id_ibu')->setLabel('Berkebutuhan khusus');
        $this->getColumnByName('kebutuhan_khusus_id_ibu')->setAllowEmpty(1);


        $fieldSet6 = new \DataDikdas\FieldsetInfo();
        $this->addRange('nama_wali', 'penghasilan_id_wali', $fieldSet6, 'Data Wali');
        $this->getColumnByName('penghasilan_id_wali')->setColumnsRadio(1);
        $this->getColumnByName('nama_wali')->setLabel('Nama');
        $this->getColumnByName('tahun_lahir_wali')->setLabel('Tahun lahir');
        ...
        $this->getColumnByName('jenjang_pendidikan_wali')->setLabel('Pendidikan');
        $this->getColumnByName('pekerjaan_id_wali')->setLabel('Pekerjaan');
        $this->getColumnByName('penghasilan_id_wali')->setLabel('Penghasilan');
        ...
        $this->getColumnByName('nm_kip')->setLabel('Nama tertera di KIP');
