...
/*
 * The Base TableInfo for Mulok Table
 */
class BaseMulokTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.MulokTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'mulok_id_str');
        $this->setHeader(           'Ref.mulok');
        $this->setLabel(            'Ref.mulok');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 1);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.mulokcombo');
        $this->setXtypeRadio(       'ref.mulokradio');
        $this->setXtypeList(        'ref.muloklist');
        ...
        $cvar->setColumnName(       'mulok_id');
        $cvar->setColumnPhpName(    'MulokId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'sk_mulok');
        $cvar->setColumnPhpName(    'SkMulok');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Sk Mulok');
        $cvar->setLabel(            'Sk mulok');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tgl_sk_mulok');
        $cvar->setColumnPhpName(    'TglSkMulok');
        $cvar->setType(             'date');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tgl Sk Mulok');
        $cvar->setLabel(            'Tgl sk mulok');
