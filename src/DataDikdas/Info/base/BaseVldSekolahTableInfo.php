...
/*
 * The Base TableInfo for VldSekolah Table
 */
class BaseVldSekolahTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.VldSekolahTableMap';
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Vld Sekolah');
        $this->setLabel(            'Vld sekolah');
