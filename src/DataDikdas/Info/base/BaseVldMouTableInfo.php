...
/*
 * The Base TableInfo for VldMou Table
 */
class BaseVldMouTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.VldMouTableMap';
    ...
    {
        $this->setName('vld_mou');
        $this->setPhpName('VldMou');
        $this->setClassname('DataDikdas\\Model\\VldMou');
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Vld Mou');
        $this->setLabel(            'Vld mou');
