...
/*
 * The Base TableInfo for Alat Table
 */
class BaseAlatTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.AlatTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_alat_str');
        $this->setHeader(           'Alat');
        $this->setLabel(            'Alat');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setHasMany(array(    "AlatDariBlockgrant","AlatLongitudinal","VldAlat"));
        $this->setBelongsTo(array(  "SekolahPaud","Sekolah","Ptk","Ruang"));
        $this->setIsSplitEntity(    );
        $this->setHasSplitEntity(   );
        $this->setSplitEntityName(  '');
        $this->setRelatingColumns(array(    "AlatDariBlockgrant.id_alat","AlatLongitudinal.id_alat","VldAlat.id_alat"));
