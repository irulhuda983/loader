...
/*
 * The Base TableInfo for JenisRombel Table
 */
class BaseJenisRombelTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisRombelTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'jenis_rombel_str');
        $this->setHeader(           'Ref.jenis Rombel');
        $this->setLabel(            'Ref.jenis rombel');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenisrombelcombo');
        $this->setXtypeRadio(       'ref.jenisrombelradio');
        $this->setXtypeList(        'ref.jenisrombellist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nm_jenis_rombel');
        $cvar->setColumnPhpName(    'NmJenisRombel');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Nm Jenis Rombel');
        $cvar->setLabel(            'Nm jenis rombel');
