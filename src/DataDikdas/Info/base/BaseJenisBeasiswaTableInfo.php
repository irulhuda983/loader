...
/*
 * The Base TableInfo for JenisBeasiswa Table
 */
class BaseJenisBeasiswaTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisBeasiswaTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'jenis_beasiswa_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'jenis_beasiswa_id_str');
        $this->setHeader(           'Ref.jenis Beasiswa');
        $this->setLabel(            'Ref.jenis beasiswa');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenisbeasiswacombo');
        $this->setXtypeRadio(       'ref.jenisbeasiswaradio');
        $this->setXtypeList(        'ref.jenisbeasiswalist');
