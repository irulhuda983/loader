...
/*
 * The Base TableInfo for Inpassing Table
 */
class BaseInpassingTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.InpassingTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'inpassing_id_str');
        $this->setHeader(           'Inpassing');
        $this->setLabel(            'Inpassing');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'no_sk_inpassing');
        $cvar->setColumnPhpName(    'NoSkInpassing');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'No Sk Inpassing');
        $cvar->setLabel(            'No sk inpassing');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tgl_sk_inpassing');
        $cvar->setColumnPhpName(    'TglSkInpassing');
        $cvar->setType(             'date');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tgl Sk Inpassing');
        $cvar->setLabel(            'Tgl sk inpassing');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tmt_inpassing');
        $cvar->setColumnPhpName(    'TmtInpassing');
        $cvar->setType(             'date');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tmt Inpassing');
        $cvar->setLabel(            'Tmt inpassing');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        $cvar->setColumnWidth(      100);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'angka_kredit');
        $cvar->setColumnPhpName(    'AngkaKredit');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Angka Kredit');
        $cvar->setLabel(            'Angka kredit');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'masa_kerja_tahun');
        $cvar->setColumnPhpName(    'MasaKerjaTahun');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Masa Kerja Tahun');
        $cvar->setLabel(            'Masa kerja tahun');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'masa_kerja_bulan');
        $cvar->setColumnPhpName(    'MasaKerjaBulan');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Masa Kerja Bulan');
        $cvar->setLabel(            'Masa kerja bulan');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
