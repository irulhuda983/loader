...
/*
 * The Base TableInfo for VldRombel Table
 */
class BaseVldRombelTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.VldRombelTableMap';
    ...
    {
        $this->setName('vld_rombel');
        $this->setPhpName('VldRombel');
        $this->setClassname('DataDikdas\\Model\\VldRombel');
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Vld Rombel');
        $this->setLabel(            'Vld rombel');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setBelongsTo(array(  "RombonganBelajar"));
