...
/*
 * The Base TableInfo for JenisHobby Table
 */
class BaseJenisHobbyTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisHobbyTableMap';
    ...
    {
        $this->setName('jenis_hobby');
        $this->setPhpName('JenisHobby');
        $this->setClassname('DataDikdas\\Model\\JenisHobby');
        $this->setPackage('DataDikdas.Model');
    }

    public function setVariables() {

        $this->setPkName(            'id_hobby');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'id_hobby_str');
        $this->setHeader(           'Ref.jenis Hobby');
        $this->setLabel(            'Ref.jenis hobby');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenishobbycombo');
        $this->setXtypeRadio(       'ref.jenishobbyradio');
        $this->setXtypeList(        'ref.jenishobbylist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nm_hobby');
        $cvar->setColumnPhpName(    'NmHobby');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Nm Hobby');
        $cvar->setLabel(            'Nm hobby');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
