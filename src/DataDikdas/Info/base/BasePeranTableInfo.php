...
/*
 * The Base TableInfo for Peran Table
 */
class BasePeranTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.PeranTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'peran_id_str');
        $this->setHeader(           'Man Akses.peran');
        $this->setLabel(            'Man akses.peran');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 1);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'manakses.perancombo');
        $this->setXtypeRadio(       'manakses.peranradio');
        $this->setXtypeList(        'manakses.peranlist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'a_perlu_sk');
        $cvar->setColumnPhpName(    'APerluSk');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Aperlu Sk');
        $cvar->setLabel(            'Aperlu sk');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
