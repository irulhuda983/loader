...
/*
 * The Base TableInfo for JenisCita Table
 */
class BaseJenisCitaTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisCitaTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_cita_str');
        $this->setHeader(           'Ref.jenis Cita');
        $this->setLabel(            'Ref.jenis cita');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jeniscitacombo');
        $this->setXtypeRadio(       'ref.jeniscitaradio');
        $this->setXtypeList(        'ref.jeniscitalist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nm_cita');
        $cvar->setColumnPhpName(    'NmCita');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Nm Cita');
        $cvar->setLabel(            'Nm cita');
