...
/*
 * The Base TableInfo for PemakaiPrasarana Table
 */
class BasePemakaiPrasaranaTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.PemakaiPrasaranaTableMap';
    ...
    {
        $this->setName('pemakai_prasarana');
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'pemakai_prasarana_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'pemakai_prasarana_id_str');
        $this->setHeader(           'Ref.pemakai Prasarana');
        $this->setLabel(            'Ref.pemakai prasarana');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.pemakaiprasaranacombo');
        $this->setXtypeRadio(       'ref.pemakaiprasaranaradio');
        $this->setXtypeList(        'ref.pemakaiprasaranalist');
        ...
        $cvar->setColumnName(       'pemakai_prasarana_id');
        $cvar->setColumnPhpName(    'PemakaiPrasaranaId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setComboXtype(       'pemakaiprasaranaid');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'jml_std_min');
        $cvar->setColumnPhpName(    'JmlStdMin');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Jml Std Min');
        $cvar->setLabel(            'Jml std min');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
