...
/*
 * The Base TableInfo for VldAnak Table
 */
class BaseVldAnakTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.VldAnakTableMap';
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Vld Anak');
        $this->setLabel(            'Vld anak');
        ...
        $cvar->setXtype(            'anakcombo');
        $cvar->setComboXtype(       'anakcombo');
