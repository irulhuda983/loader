...
/*
 * The Base TableInfo for PangkatGolongan Table
 */
class BasePangkatGolonganTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.PangkatGolonganTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'pangkat_golongan_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'pangkat_golongan_id_str');
        $this->setHeader(           'Ref.pangkat Golongan');
        $this->setLabel(            'Ref.pangkat golongan');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.pangkatgolongancombo');
        $this->setXtypeRadio(       'ref.pangkatgolonganradio');
        $this->setXtypeList(        'ref.pangkatgolonganlist');
