...
/*
 * The Base TableInfo for GugusSekolah Table
 */
class BaseGugusSekolahTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.GugusSekolahTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'gugus_id_str');
        $this->setHeader(           'Gugus Sekolah');
        $this->setLabel(            'Gugus sekolah');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setHasMany(array(    "AnggotaGugus"));
        $this->setIsSplitEntity(    );
        $this->setHasSplitEntity(   );
        $this->setSplitEntityName(  '');
        $this->setRelatingColumns(array(    "AnggotaGugus.gugus_id"));
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'sk_gugus');
        $cvar->setColumnPhpName(    'SkGugus');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Sk Gugus');
        $cvar->setLabel(            'Sk gugus');
		...
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'JenisGugus');
        $cvar->setMin(              0);
        $cvar->setMax(              9);
        ...
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'jenisguguscombo');
        $cvar->setComboXtype(       'jenisguguscombo');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'sekolah_inti_id');
        $cvar->setColumnPhpName(    'SekolahIntiId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              9);
        $cvar->setHeader(           'Sekolah Inti');
        $cvar->setLabel(            'Sekolah inti');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
