...
/*
 * The Base TableInfo for Semester Table
 */
class BaseSemesterTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.SemesterTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'semester_id_str');
        $this->setHeader(           'Ref.semester');
        $this->setLabel(            'Ref.semester');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.semestercombo');
        $this->setXtypeRadio(       'ref.semesterradio');
        $this->setXtypeList(        'ref.semesterlist');
