...
/*
 * The Base TableInfo for RiwayatGajiBerkala Table
 */
class BaseRiwayatGajiBerkalaTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.RiwayatGajiBerkalaTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'riwayat_gaji_berkala_id');
        $this->setIsData(           1);
        ...
        $this->setRendererString(   'riwayat_gaji_berkala_id_str');
        $this->setHeader(           'Riwayat Gaji Berkala');
        $this->setLabel(            'Riwayat gaji berkala');
        ...
        $cvar->setColumnName(       'riwayat_gaji_berkala_id');
        $cvar->setColumnPhpName(    'RiwayatGajiBerkalaId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tmt_kgb');
        $cvar->setColumnPhpName(    'TmtKgb');
        $cvar->setType(             'date');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tmt Kgb');
        $cvar->setLabel(            'Tmt kgb');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        $cvar->setColumnWidth(      100);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'gaji_pokok');
        $cvar->setColumnPhpName(    'GajiPokok');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Gaji Pokok');
        $cvar->setLabel(            'Gaji pokok');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
