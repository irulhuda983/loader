...
/*
 * The Base TableInfo for VldPesertaDidik Table
 */
class BaseVldPesertaDidikTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.VldPesertaDidikTableMap';
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Vld Peserta Didik');
        $this->setLabel(            'Vld peserta didik');
