...
/*
 * The Base TableInfo for VldPtk Table
 */
class BaseVldPtkTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.VldPtkTableMap';
    ...
    {
        $this->setName('vld_ptk');
        $this->setPhpName('VldPtk');
        $this->setClassname('DataDikdas\\Model\\VldPtk');
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Vld Ptk');
        $this->setLabel(            'Vld ptk');
