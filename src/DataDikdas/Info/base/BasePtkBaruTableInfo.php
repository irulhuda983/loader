...
/*
 * The Base TableInfo for PtkBaru Table
 */
class BasePtkBaruTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.PtkBaruTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'ptk_baru_id_str');
        $this->setHeader(           'Ptk Baru');
        $this->setLabel(            'Ptk baru');
        ...
        $cvar->setColumnName(       'ptk_baru_id');
        $cvar->setColumnPhpName(    'PtkBaruId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nama_ptk');
        $cvar->setColumnPhpName(    'NamaPtk');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Nama Ptk');
        $cvar->setLabel(            'Nama ptk');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
