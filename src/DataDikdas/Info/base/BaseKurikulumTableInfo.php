...
/*
 * The Base TableInfo for Kurikulum Table
 */
class BaseKurikulumTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.KurikulumTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'kurikulum_id_str');
        $this->setHeader(           'Ref.kurikulum');
        $this->setLabel(            'Ref.kurikulum');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.kurikulumcombo');
        $this->setXtypeRadio(       'ref.kurikulumradio');
        $this->setXtypeList(        'ref.kurikulumlist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nama_kurikulum');
        $cvar->setColumnPhpName(    'NamaKurikulum');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Nama Kurikulum');
        $cvar->setLabel(            'Nama kurikulum');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'mulai_berlaku');
        $cvar->setColumnPhpName(    'MulaiBerlaku');
        $cvar->setType(             'date');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Mulai Berlaku');
        $cvar->setLabel(            'Mulai berlaku');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'sistem_sks');
        $cvar->setColumnPhpName(    'SistemSks');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Sistem Sks');
        $cvar->setLabel(            'Sistem sks');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'total_sks');
        $cvar->setColumnPhpName(    'TotalSks');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Total Sks');
        $cvar->setLabel(            'Total sks');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
