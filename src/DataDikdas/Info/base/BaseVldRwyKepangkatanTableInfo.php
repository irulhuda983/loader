...
/*
 * The Base TableInfo for VldRwyKepangkatan Table
 */
class BaseVldRwyKepangkatanTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.VldRwyKepangkatanTableMap';
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Vld Rwy Kepangkatan');
        $this->setLabel(            'Vld rwy kepangkatan');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setBelongsTo(array(  "RwyKepangkatan"));
		...
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'RwyKepangkatan');
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Riwayat Kepangkatan');
        $cvar->setLabel(            'Riwayat kepangkatan');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        $cvar->setColumnWidth(      140);
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'rwykepangkatancombo');
        $cvar->setComboXtype(       'rwykepangkatancombo');
