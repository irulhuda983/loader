...
/*
 * The Base TableInfo for GroupMatpel Table
 */
class BaseGroupMatpelTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.GroupMatpelTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'gmp_id_str');
        $this->setHeader(           'Ref.group Matpel');
        $this->setLabel(            'Ref.group matpel');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setHasMany(array(    "MataPelajaranKurikulum"));
        $this->setIsSplitEntity(    );
        $this->setHasSplitEntity(   );
        $this->setSplitEntityName(  '');
        $this->setRelatingColumns(array(    "MataPelajaranKurikulum.gmp_id"));
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nama_group');
        $cvar->setColumnPhpName(    'NamaGroup');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Nama Group');
        $cvar->setLabel(            'Nama group');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'jumlah_sks_maksimum');
        $cvar->setColumnPhpName(    'JumlahSksMaksimum');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Jumlah Sks Maksimum');
        $cvar->setLabel(            'Jumlah sks maksimum');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
