...
/*
 * The Base TableInfo for VldBeaPd Table
 */
class BaseVldBeaPdTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.VldBeaPdTableMap';
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Vld Bea Pd');
        $this->setLabel(            'Vld bea pd');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setBelongsTo(array(  "BeasiswaPesertaDidik"));
		...
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'BeasiswaPesertaDidik');
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Beasiswa Peserta Didik');
        $cvar->setLabel(            'Beasiswa peserta didik');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        $cvar->setColumnWidth(      140);
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'beasiswapesertadidikcombo');
        $cvar->setComboXtype(       'beasiswapesertadidikcombo');
