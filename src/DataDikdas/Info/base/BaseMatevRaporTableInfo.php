...
/*
 * The Base TableInfo for MatevRapor Table
 */
class BaseMatevRaporTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.MatevRaporTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_evaluasi_str');
        $this->setHeader(           'Nilai.matev Rapor');
        $this->setLabel(            'Nilai.matev rapor');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setHasMany(array(    "NilaiRapor"));
        $this->setIsSplitEntity(    );
        $this->setHasSplitEntity(   );
        $this->setSplitEntityName(  '');
        $this->setRelatingColumns(array(    "NilaiRapor.id_evaluasi"));
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nm_mata_evaluasi');
        $cvar->setColumnPhpName(    'NmMataEvaluasi');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Nm Mata Evaluasi');
        $cvar->setLabel(            'Nm mata evaluasi');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'a_dari_template');
        $cvar->setColumnPhpName(    'ADariTemplate');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Adari Template');
        $cvar->setLabel(            'Adari template');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'no_urut');
        $cvar->setColumnPhpName(    'NoUrut');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'No Urut');
        $cvar->setLabel(            'No urut');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'kkm_kognitif');
        $cvar->setColumnPhpName(    'KkmKognitif');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Kkm Kognitif');
        $cvar->setLabel(            'Kkm kognitif');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'kkm_psikomotorik');
        $cvar->setColumnPhpName(    'KkmPsikomotorik');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Kkm Psikomotorik');
        $cvar->setLabel(            'Kkm psikomotorik');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
