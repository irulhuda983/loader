...
/*
 * The Base TableInfo for AktivitasKepanitiaan Table
 */
class BaseAktivitasKepanitiaanTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.AktivitasKepanitiaanTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_akt_pan_str');
        $this->setHeader(           'Aktivitas Kepanitiaan');
        $this->setLabel(            'Aktivitas kepanitiaan');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setBelongsTo(array(  "Kepanitiaan"));
        ...
        $cvar->setColumnName(       'id_akt_pan');
        $cvar->setColumnPhpName(    'IdAktPan');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
		...
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'Kepanitiaan');
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Panitia');
        $cvar->setLabel(            'panitia');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        $cvar->setColumnWidth(      140);
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'kepanitiaancombo');
        $cvar->setComboXtype(       'kepanitiaancombo');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'id_jns_akt_pan');
        $cvar->setColumnPhpName(    'IdJnsAktPan');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'JenisAktivitasKepanitiaan');
        $cvar->setMin(              0);
        $cvar->setMax(              0);
        $cvar->setHeader(           'Jns Akt Pan');
        $cvar->setLabel(            'jns akt pan');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      140);
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'jenisaktivitaskepanitiaanradiogroup');
        $cvar->setComboXtype(       'jenisaktivitaskepanitiaancombo');
        $cvar->setDisplayField(     'Nama');
        $cvar->setValidationType(   '');
        $cvar->setAllowEmpty(       0);
        $cvar->setCompositeKey(     0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'frek_akt_pan');
        $cvar->setColumnPhpName(    'FrekAktPan');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Frek Akt Pan');
        $cvar->setLabel(            'Frek akt pan');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'ket_akt_pan');
        $cvar->setColumnPhpName(    'KetAktPan');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Ket Akt Pan');
        $cvar->setLabel(            'Ket akt pan');
