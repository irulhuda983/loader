...
/*
 * The Base TableInfo for SumberDana Table
 */
class BaseSumberDanaTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.SumberDanaTableMap';
    ...
    {
        $this->setName('sumber_dana');
        $this->setPhpName('SumberDana');
        $this->setClassname('DataDikdas\\Model\\SumberDana');
        $this->setPackage('DataDikdas.Model');
    }

    public function setVariables() {

        $this->setPkName(            'sumber_dana_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'sumber_dana_id_str');
        $this->setHeader(           'Ref.sumber Dana');
        $this->setLabel(            'Ref.sumber dana');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.sumberdanacombo');
        $this->setXtypeRadio(       'ref.sumberdanaradio');
        $this->setXtypeList(        'ref.sumberdanalist');
