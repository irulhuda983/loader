...
/*
 * The Base TableInfo for VldPembelajaran Table
 */
class BaseVldPembelajaranTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.VldPembelajaranTableMap';
    ...
    {
        $this->setName('vld_pembelajaran');
        $this->setPhpName('VldPembelajaran');
        $this->setClassname('DataDikdas\\Model\\VldPembelajaran');
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Vld Pembelajaran');
        $this->setLabel(            'Vld pembelajaran');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setBelongsTo(array(  "Pembelajaran"));
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Pembelajaran');
        $cvar->setLabel(            'Pembelajaran');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
