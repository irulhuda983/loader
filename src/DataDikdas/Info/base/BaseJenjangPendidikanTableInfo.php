...
/*
 * The Base TableInfo for JenjangPendidikan Table
 */
class BaseJenjangPendidikanTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenjangPendidikanTableMap';
    ...
    {
        $this->setName('jenjang_pendidikan');
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'jenjang_pendidikan_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'jenjang_pendidikan_id_str');
        $this->setHeader(           'Ref.jenjang Pendidikan');
        $this->setLabel(            'Ref.jenjang pendidikan');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenjangpendidikancombo');
        $this->setXtypeRadio(       'ref.jenjangpendidikanradio');
        $this->setXtypeList(        'ref.jenjangpendidikanlist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'jenjang_lembaga');
        $cvar->setColumnPhpName(    'JenjangLembaga');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Jenjang Lembaga');
        $cvar->setLabel(            'Jenjang lembaga');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'jenjang_orang');
        $cvar->setColumnPhpName(    'JenjangOrang');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Jenjang Orang');
        $cvar->setLabel(            'Jenjang orang');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
