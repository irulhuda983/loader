...
/*
 * The Base TableInfo for BantuanPd Table
 */
class BaseBantuanPdTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.BantuanPdTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_bantuan_pd_str');
        $this->setHeader(           'Bantuan Pd');
        $this->setLabel(            'Bantuan pd');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setBelongsTo(array(  "AnggotaRombel","NilaiSmt"));
        ...
        $cvar->setColumnName(       'id_bantuan_pd');
        $cvar->setColumnPhpName(    'IdBantuanPd');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
		...
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'AnggotaRombel');
        $cvar->setMin(              0);
        $cvar->setMax(              52);
        ...
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'anggotarombelcombo');
        $cvar->setComboXtype(       'anggotarombelcombo');
        $cvar->setDisplayField(     'Nama');
        $cvar->setValidationType(   '');
        $cvar->setAllowEmpty(       0);
        $cvar->setCompositeKey(     0);
