...
/*
 * The Base TableInfo for VldAlat Table
 */
class BaseVldAlatTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.VldAlatTableMap';
    ...
    {
        $this->setName('vld_alat');
        $this->setPhpName('VldAlat');
        $this->setClassname('DataDikdas\\Model\\VldAlat');
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Vld Alat');
        $this->setLabel(            'Vld alat');
