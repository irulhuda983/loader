...
/*
 * The Base TableInfo for JenisAktivitasKepanitiaan Table
 */
class BaseJenisAktivitasKepanitiaanTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisAktivitasKepanitiaanTableMap';
    ...
    {
        $this->setName('jenis_aktivitas_kepanitiaan');
        $this->setPhpName('JenisAktivitasKepanitiaan');
        $this->setClassname('DataDikdas\\Model\\JenisAktivitasKepanitiaan');
        $this->setPackage('DataDikdas.Model');
    }

    public function setVariables() {

        $this->setPkName(            'id_jns_akt_pan');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'id_jns_akt_pan_str');
        $this->setHeader(           'Ref.jenis Aktivitas Kepanitiaan');
        $this->setLabel(            'Ref.jenis aktivitas kepanitiaan');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 1);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenisaktivitaskepanitiaancombo');
        $this->setXtypeRadio(       'ref.jenisaktivitaskepanitiaanradio');
        $this->setXtypeList(        'ref.jenisaktivitaskepanitiaanlist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nm_jns_akt_pan');
        $cvar->setColumnPhpName(    'NmJnsAktPan');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Nm Jns Akt Pan');
        $cvar->setLabel(            'Nm jns akt pan');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
