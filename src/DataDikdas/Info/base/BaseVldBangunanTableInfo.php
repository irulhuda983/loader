...
/*
 * The Base TableInfo for VldBangunan Table
 */
class BaseVldBangunanTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.VldBangunanTableMap';
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Vld Bangunan');
        $this->setLabel(            'Vld bangunan');
