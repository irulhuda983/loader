...
/*
 * The Base TableInfo for TugasTambahan Table
 */
class BaseTugasTambahanTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.TugasTambahanTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'ptk_tugas_tambahan_id');
        $this->setIsData(           1);
        ...
        $this->setRendererString(   'ptk_tugas_tambahan_id_str');
        $this->setHeader(           'Tugas Tambahan');
        $this->setLabel(            'Tugas tambahan');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setHasMany(array(    "VldTugasTambahan"));
        $this->setBelongsTo(array(  "Ptk","Ruang","SekolahPaud","Sekolah"));
        $this->setIsSplitEntity(    );
        $this->setHasSplitEntity(   );
        $this->setSplitEntityName(  '');
        $this->setRelatingColumns(array(    "VldTugasTambahan.ptk_tugas_tambahan_id"));
		...
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'JabatanTugasPtk');
        $cvar->setMin(              0);
        $cvar->setMax(              109);
        $cvar->setHeader(           'Jabatan Ptk');
        $cvar->setLabel(            'Jabatan ptk');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      170);
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'jabatantugasptkcombo');
        $cvar->setComboXtype(       'jabatantugasptkcombo');
        $cvar->setDisplayField(     'Nama');
        $cvar->setValidationType(   '');
        $cvar->setAllowEmpty(       0);
        $cvar->setCompositeKey(     0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tmt_tambahan');
        $cvar->setColumnPhpName(    'TmtTambahan');
        $cvar->setType(             'date');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tmt Tambahan');
        $cvar->setLabel(            'Tmt tambahan');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tst_tambahan');
        $cvar->setColumnPhpName(    'TstTambahan');
        $cvar->setType(             'date');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tst Tambahan');
        $cvar->setLabel(            'Tst tambahan');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        $cvar->setColumnWidth(      100);
        $cvar->setHideColumn(       0);
