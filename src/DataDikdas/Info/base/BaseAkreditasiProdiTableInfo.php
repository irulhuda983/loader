...
/*
 * The Base TableInfo for AkreditasiProdi Table
 */
class BaseAkreditasiProdiTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.AkreditasiProdiTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'akred_prodi_id_str');
        $this->setHeader(           'Akreditasi Prodi');
        $this->setLabel(            'Akreditasi prodi');
        ...
        $cvar->setColumnName(       'akred_prodi_id');
        $cvar->setColumnPhpName(    'AkredProdiId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
		...
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'Akreditasi');
        $cvar->setMin(              0);
        $cvar->setMax(              5);
        $cvar->setHeader(           'Akreditasi');
        $cvar->setLabel(            'Akreditasi');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      150);
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'akreditasicombo');
        $cvar->setComboXtype(       'akreditasicombo');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'no_sk_akred');
        $cvar->setColumnPhpName(    'NoSkAkred');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'No Sk Akred');
        $cvar->setLabel(            'No sk akred');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tgl_sk_akred');
        $cvar->setColumnPhpName(    'TglSkAkred');
        $cvar->setType(             'date');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tgl Sk Akred');
        $cvar->setLabel(            'Tgl sk akred');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tgl_akhir_akred');
        $cvar->setColumnPhpName(    'TglAkhirAkred');
        $cvar->setType(             'date');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tgl Akhir Akred');
        $cvar->setLabel(            'Tgl akhir akred');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        $cvar->setColumnWidth(      100);
        $cvar->setHideColumn(       0);
