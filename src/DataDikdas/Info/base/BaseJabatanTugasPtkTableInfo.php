...
/*
 * The Base TableInfo for JabatanTugasPtk Table
 */
class BaseJabatanTugasPtkTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JabatanTugasPtkTableMap';
    ...
    {
        $this->setName('jabatan_tugas_ptk');
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'jabatan_ptk_id_str');
        $this->setHeader(           'Ref.jabatan Tugas Ptk');
        $this->setLabel(            'Ref.jabatan tugas ptk');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jabatantugasptkcombo');
        $this->setXtypeRadio(       'ref.jabatantugasptkradio');
        $this->setXtypeList(        'ref.jabatantugasptklist');
        ...
        $cvar->setColumnName(       'jabatan_ptk_id');
        $cvar->setColumnPhpName(    'JabatanPtkId');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'jabatan_utama');
        $cvar->setColumnPhpName(    'JabatanUtama');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Jabatan Utama');
        $cvar->setLabel(            'Jabatan utama');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tugas_tambahan_guru');
        $cvar->setColumnPhpName(    'TugasTambahanGuru');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tugas Tambahan Guru');
        $cvar->setLabel(            'Tugas tambahan guru');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'jumlah_jam_diakui');
        $cvar->setColumnPhpName(    'JumlahJamDiakui');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Jumlah Jam Diakui');
        $cvar->setLabel(            'Jumlah jam diakui');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'harus_refer_unit_org');
        $cvar->setColumnPhpName(    'HarusReferUnitOrg');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Harus Refer Unit Org');
        $cvar->setLabel(            'Harus refer unit org');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
