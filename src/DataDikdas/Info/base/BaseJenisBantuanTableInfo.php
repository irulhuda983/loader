...
/*
 * The Base TableInfo for JenisBantuan Table
 */
class BaseJenisBantuanTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisBantuanTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'jenis_bantuan_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'jenis_bantuan_id_str');
        $this->setHeader(           'Ref.jenis Bantuan');
        $this->setLabel(            'Ref.jenis bantuan');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenisbantuancombo');
        $this->setXtypeRadio(       'ref.jenisbantuanradio');
        $this->setXtypeList(        'ref.jenisbantuanlist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'untuk_sekolah');
        $cvar->setColumnPhpName(    'UntukSekolah');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Untuk Sekolah');
        $cvar->setLabel(            'Untuk sekolah');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
