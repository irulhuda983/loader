...
/*
 * The Base TableInfo for SumberListrik Table
 */
class BaseSumberListrikTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.SumberListrikTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'sumber_listrik_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'sumber_listrik_id_str');
        $this->setHeader(           'Ref.sumber Listrik');
        $this->setLabel(            'Ref.sumber listrik');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.sumberlistrikcombo');
        $this->setXtypeRadio(       'ref.sumberlistrikradio');
        $this->setXtypeList(        'ref.sumberlistriklist');
