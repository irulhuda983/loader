...
/*
 * The Base TableInfo for Blockgrant Table
 */
class BaseBlockgrantTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.BlockgrantTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'blockgrant_id_str');
        $this->setHeader(           'Blockgrant');
        $this->setLabel(            'Blockgrant');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setHasMany(array(    "AlatDariBlockgrant","AngkutanDariBlockgrant","BangunanDariBlockgrant","TanahDariBlockgrant"));
        $this->setBelongsTo(array(  "SekolahPaud","Sekolah"));
        $this->setIsSplitEntity(    );
        $this->setHasSplitEntity(   );
        $this->setSplitEntityName(  '');
        $this->setRelatingColumns(array(    "AlatDariBlockgrant.blockgrant_id","AngkutanDariBlockgrant.blockgrant_id","BangunanDariBlockgrant.blockgrant_id","TanahDariBlockgrant.blockgrant_id"));
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'jenis_bantuan_id');
        $cvar->setColumnPhpName(    'JenisBantuanId');
        $cvar->setType(             'int');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'JenisBantuan');
        $cvar->setMin(              0);
        $cvar->setMax(              52);
        $cvar->setHeader(           'Jenis Bantuan');
        $cvar->setLabel(            'Jenis bantuan');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      170);
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'jenisbantuancombo');
        $cvar->setComboXtype(       'jenisbantuancombo');
        $cvar->setDisplayField(     'Nama');
        $cvar->setValidationType(   '');
        $cvar->setAllowEmpty(       0);
        $cvar->setCompositeKey(     0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'besar_bantuan');
        $cvar->setColumnPhpName(    'BesarBantuan');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Besar Bantuan');
        $cvar->setLabel(            'Besar bantuan');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'dana_pendamping');
        $cvar->setColumnPhpName(    'DanaPendamping');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Dana Pendamping');
        $cvar->setLabel(            'Dana pendamping');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'peruntukan_dana');
        $cvar->setColumnPhpName(    'PeruntukanDana');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Peruntukan Dana');
        $cvar->setLabel(            'Peruntukan dana');
        $cvar->setInputLength(      50);
        $cvar->setFieldWidth(       150);
        $cvar->setColumnWidth(      210);
        $cvar->setHideColumn(       0);
