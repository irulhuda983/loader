...
/*
 * The Base TableInfo for JenisDiklat Table
 */
class BaseJenisDiklatTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisDiklatTableMap';
    ...
    {
        $this->setName('jenis_diklat');
        $this->setPhpName('JenisDiklat');
        $this->setClassname('DataDikdas\\Model\\JenisDiklat');
        $this->setPackage('DataDikdas.Model');
    }

    public function setVariables() {

        $this->setPkName(            'jenis_diklat_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'jenis_diklat_id_str');
        $this->setHeader(           'Ref.jenis Diklat');
        $this->setLabel(            'Ref.jenis diklat');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenisdiklatcombo');
        $this->setXtypeRadio(       'ref.jenisdiklatradio');
        $this->setXtypeList(        'ref.jenisdiklatlist');
