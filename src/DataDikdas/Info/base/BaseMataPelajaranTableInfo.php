...
/*
 * The Base TableInfo for MataPelajaran Table
 */
class BaseMataPelajaranTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.MataPelajaranTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'mata_pelajaran_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'mata_pelajaran_id_str');
        $this->setHeader(           'Ref.mata Pelajaran');
        $this->setLabel(            'Ref.mata pelajaran');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.matapelajarancombo');
        $this->setXtypeRadio(       'ref.matapelajaranradio');
        $this->setXtypeList(        'ref.matapelajaranlist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'pilihan_sekolah');
        $cvar->setColumnPhpName(    'PilihanSekolah');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Pilihan Sekolah');
        $cvar->setLabel(            'Pilihan sekolah');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'pilihan_buku');
        $cvar->setColumnPhpName(    'PilihanBuku');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Pilihan Buku');
        $cvar->setLabel(            'Pilihan buku');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'pilihan_kepengawasan');
        $cvar->setColumnPhpName(    'PilihanKepengawasan');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Pilihan Kepengawasan');
        $cvar->setLabel(            'Pilihan kepengawasan');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'pilihan_evaluasi');
        $cvar->setColumnPhpName(    'PilihanEvaluasi');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Pilihan Evaluasi');
        $cvar->setLabel(            'Pilihan evaluasi');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
