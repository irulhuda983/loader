...
/*
 * The Base TableInfo for VldPdLong Table
 */
class BaseVldPdLongTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.VldPdLongTableMap';
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Vld Pd Long');
        $this->setLabel(            'Vld pd long');
		...
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'PesertaDidikLongitudinal');
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        ...
        $cvar->setXtype(            'pesertadidiklongitudinalcombo');
        $cvar->setComboXtype(       'pesertadidiklongitudinalcombo');
