...
/*
 * The Base TableInfo for VldPtkTerdaftar Table
 */
class BaseVldPtkTerdaftarTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.VldPtkTerdaftarTableMap';
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Vld Ptk Terdaftar');
        $this->setLabel(            'Vld ptk terdaftar');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setBelongsTo(array(  "PtkTerdaftar"));
