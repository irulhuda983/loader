...
{
    const CLASS_NAME = 'DataDikdas.Info.JenisSaranaTableMap';
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Ref.jenis Sarana');
        $this->setLabel(            'Ref.jenis sarana');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenissaranacombo');
        $this->setXtypeRadio(       'ref.jenissaranaradio');
        $this->setXtypeList(        'ref.jenissaranalist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'a_alat');
        $cvar->setColumnPhpName(    'AAlat');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'a_angkutan');
        $cvar->setColumnPhpName(    'AAngkutan');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Aangkutan');
        $cvar->setLabel(            'Aangkutan');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'spm_qty_min_per_siswa');
        $cvar->setColumnPhpName(    'SpmQtyMinPerSiswa');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Spm Qty Min Per Siswa');
        $cvar->setLabel(            'Spm qty min per siswa');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'spm_qty_min_per_sekolah');
        $cvar->setColumnPhpName(    'SpmQtyMinPerSekolah');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Spm Qty Min Per Sekolah');
        $cvar->setLabel(            'Spm qty min per sekolah');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
