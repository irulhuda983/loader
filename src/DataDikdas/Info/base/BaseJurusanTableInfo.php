...
/*
 * The Base TableInfo for Jurusan Table
 */
class BaseJurusanTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JurusanTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'jurusan_id_str');
        $this->setHeader(           'Ref.jurusan');
        $this->setLabel(            'Ref.jurusan');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jurusancombo');
        $this->setXtypeRadio(       'ref.jurusanradio');
        $this->setXtypeList(        'ref.jurusanlist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nama_jurusan');
        $cvar->setColumnPhpName(    'NamaJurusan');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Nama Jurusan');
        $cvar->setLabel(            'Nama jurusan');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'untuk_sma');
        $cvar->setColumnPhpName(    'UntukSma');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Untuk Sma');
        $cvar->setLabel(            'Untuk sma');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'untuk_smk');
        $cvar->setColumnPhpName(    'UntukSmk');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Untuk Smk');
        $cvar->setLabel(            'Untuk smk');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'untuk_pt');
        $cvar->setColumnPhpName(    'UntukPt');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Untuk Pt');
        $cvar->setLabel(            'Untuk pt');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'untuk_slb');
        $cvar->setColumnPhpName(    'UntukSlb');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Untuk Slb');
        $cvar->setLabel(            'Untuk slb');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'untuk_smklb');
        $cvar->setColumnPhpName(    'UntukSmklb');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Untuk Smklb');
        $cvar->setLabel(            'Untuk smklb');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'jurusan_induk');
        $cvar->setColumnPhpName(    'JurusanInduk');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              21);
        $cvar->setHeader(           'Jurusan Induk');
        $cvar->setLabel(            'Jurusan induk');
        $cvar->setInputLength(      25);
        $cvar->setFieldWidth(       75);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'level_bidang_id');
        $cvar->setColumnPhpName(    'LevelBidangId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'KelompokBidang');
        $cvar->setMin(              0);
        $cvar->setMax(              21);
        $cvar->setHeader(           'Level Bidang');
        $cvar->setLabel(            'Level bidang');
        $cvar->setInputLength(      5);
        $cvar->setFieldWidth(       15);
        $cvar->setColumnWidth(      140);
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'kelompokbidangcombo');
        $cvar->setComboXtype(       'kelompokbidangcombo');
        $cvar->setDisplayField(     'Nama');
        $cvar->setValidationType(   '');
        $cvar->setAllowEmpty(       0);
        $cvar->setCompositeKey(     0);
