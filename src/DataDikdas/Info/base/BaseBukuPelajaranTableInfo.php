...
/*
 * The Base TableInfo for BukuPelajaran Table
 */
class BaseBukuPelajaranTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.BukuPelajaranTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'buku_pelajaran_id');
        $this->setIsData(           1);
        ...
        $this->setRendererString(   'buku_pelajaran_id_str');
        $this->setHeader(           'Buku Pelajaran');
        $this->setLabel(            'Buku pelajaran');
        ...
        $cvar->setColumnName(       'buku_pelajaran_id');
        $cvar->setColumnPhpName(    'BukuPelajaranId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setComboXtype(       'bukupelajaranid');
