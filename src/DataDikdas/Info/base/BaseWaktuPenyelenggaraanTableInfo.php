...
/*
 * The Base TableInfo for WaktuPenyelenggaraan Table
 */
class BaseWaktuPenyelenggaraanTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.WaktuPenyelenggaraanTableMap';
    ...
    {
        $this->setName('waktu_penyelenggaraan');
        $this->setPhpName('WaktuPenyelenggaraan');
        $this->setClassname('DataDikdas\\Model\\WaktuPenyelenggaraan');
        $this->setPackage('DataDikdas.Model');
    }

    public function setVariables() {

        $this->setPkName(            'waktu_penyelenggaraan_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'waktu_penyelenggaraan_id_str');
        $this->setHeader(           'Ref.waktu Penyelenggaraan');
        $this->setLabel(            'Ref.waktu penyelenggaraan');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.waktupenyelenggaraancombo');
        $this->setXtypeRadio(       'ref.waktupenyelenggaraanradio');
        $this->setXtypeList(        'ref.waktupenyelenggaraanlist');
