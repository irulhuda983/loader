...
/*
 * The Base TableInfo for TemplateRapor Table
 */
class BaseTemplateRaporTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.TemplateRaporTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'template_rapor_id');
        $this->setIsData(           1);
        ...
        $this->setRendererString(   'template_rapor_id_str');
        $this->setHeader(           'Ref.template Rapor');
        $this->setLabel(            'Ref.template rapor');
        ...
        $cvar->setColumnName(       'template_rapor_id');
        $cvar->setColumnPhpName(    'TemplateRaporId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setComboXtype(       'templateraporid');
