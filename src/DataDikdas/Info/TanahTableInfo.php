...
class TanahTableInfo extends base\BaseTanahTableInfo
{
    ...
    public function setVariables() {
        ...
        $this->getColumnByName('luas')->setHeader('Luas (m)');
        $this->getColumnByName('luas')->setLabel('Luas (m)');
        $this->getColumnByName('luas')->setColumnWidth('120');
        $this->getColumnByName('luas_lahan_tersedia')->setHeader('Luas Lahan Tersedia (m)');
        $this->getColumnByName('luas_lahan_tersedia')->setLabel('Luas Lahan Tersedia (m)');
