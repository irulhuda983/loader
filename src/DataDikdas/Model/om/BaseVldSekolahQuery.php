...
abstract class BaseVldSekolahQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "logid", "sekolah_id", "idtype", "status_validasi", "field_error", "error_message", "app_username", "create_date", "last_update", "soft_delete", "last_sync", "updater_id" FROM "vld_sekolah" WHERE "logid" = :p0';
        try {
