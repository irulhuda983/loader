...
abstract class BaseBidangUsahaPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('BidangUsahaId', 'NamaBidangUsaha', 'CreateDate', 'LastUpdate', 'ExpiredDate', 'LastSync', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('bidangUsahaId', 'namaBidangUsaha', 'createDate', 'lastUpdate', 'expiredDate', 'lastSync', ),
        BasePeer::TYPE_COLNAME => array (BidangUsahaPeer::BIDANG_USAHA_ID, BidangUsahaPeer::NAMA_BIDANG_USAHA, BidangUsahaPeer::CREATE_DATE, BidangUsahaPeer::LAST_UPDATE, BidangUsahaPeer::EXPIRED_DATE, BidangUsahaPeer::LAST_SYNC, ),
        BasePeer::TYPE_RAW_COLNAME => array ('BIDANG_USAHA_ID', 'NAMA_BIDANG_USAHA', 'CREATE_DATE', 'LAST_UPDATE', 'EXPIRED_DATE', 'LAST_SYNC', ),
        BasePeer::TYPE_FIELDNAME => array ('bidang_usaha_id', 'nama_bidang_usaha', 'create_date', 'last_update', 'expired_date', 'last_sync', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('BidangUsahaId' => 0, 'NamaBidangUsaha' => 1, 'CreateDate' => 2, 'LastUpdate' => 3, 'ExpiredDate' => 4, 'LastSync' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('bidangUsahaId' => 0, 'namaBidangUsaha' => 1, 'createDate' => 2, 'lastUpdate' => 3, 'expiredDate' => 4, 'lastSync' => 5, ),
        BasePeer::TYPE_COLNAME => array (BidangUsahaPeer::BIDANG_USAHA_ID => 0, BidangUsahaPeer::NAMA_BIDANG_USAHA => 1, BidangUsahaPeer::CREATE_DATE => 2, BidangUsahaPeer::LAST_UPDATE => 3, BidangUsahaPeer::EXPIRED_DATE => 4, BidangUsahaPeer::LAST_SYNC => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('BIDANG_USAHA_ID' => 0, 'NAMA_BIDANG_USAHA' => 1, 'CREATE_DATE' => 2, 'LAST_UPDATE' => 3, 'EXPIRED_DATE' => 4, 'LAST_SYNC' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('bidang_usaha_id' => 0, 'nama_bidang_usaha' => 1, 'create_date' => 2, 'last_update' => 3, 'expired_date' => 4, 'last_sync' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
