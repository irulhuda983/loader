...
abstract class BasePtk extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->nuks = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->status_kepegawaian_id = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
            $this->jenis_ptk_id = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->pengawas_bidang_studi_id = ($row[$startcol + 13] !== null) ? (int) $row[$startcol + 13] : null;
            $this->agama_id = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
            $this->alamat_jalan = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
            $this->rt = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
            $this->rw = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
            $this->nama_dusun = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
            $this->desa_kelurahan = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
            $this->kode_wilayah = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
            $this->kode_pos = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
            $this->lintang = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
            $this->bujur = ($row[$startcol + 23] !== null) ? (string) $row[$startcol + 23] : null;
            $this->no_telepon_rumah = ($row[$startcol + 24] !== null) ? (string) $row[$startcol + 24] : null;
            $this->no_hp = ($row[$startcol + 25] !== null) ? (string) $row[$startcol + 25] : null;
            $this->email = ($row[$startcol + 26] !== null) ? (string) $row[$startcol + 26] : null;
            $this->status_keaktifan_id = ($row[$startcol + 27] !== null) ? (string) $row[$startcol + 27] : null;
            $this->sk_cpns = ($row[$startcol + 28] !== null) ? (string) $row[$startcol + 28] : null;
            $this->tgl_cpns = ($row[$startcol + 29] !== null) ? (string) $row[$startcol + 29] : null;
            $this->sk_pengangkatan = ($row[$startcol + 30] !== null) ? (string) $row[$startcol + 30] : null;
            $this->tmt_pengangkatan = ($row[$startcol + 31] !== null) ? (string) $row[$startcol + 31] : null;
            $this->lembaga_pengangkat_id = ($row[$startcol + 32] !== null) ? (string) $row[$startcol + 32] : null;
            $this->pangkat_golongan_id = ($row[$startcol + 33] !== null) ? (string) $row[$startcol + 33] : null;
            $this->keahlian_laboratorium_id = ($row[$startcol + 34] !== null) ? (int) $row[$startcol + 34] : null;
            $this->sumber_gaji_id = ($row[$startcol + 35] !== null) ? (string) $row[$startcol + 35] : null;
            $this->nama_ibu_kandung = ($row[$startcol + 36] !== null) ? (string) $row[$startcol + 36] : null;
            $this->status_perkawinan = ($row[$startcol + 37] !== null) ? (string) $row[$startcol + 37] : null;
            $this->nama_suami_istri = ($row[$startcol + 38] !== null) ? (string) $row[$startcol + 38] : null;
            $this->nip_suami_istri = ($row[$startcol + 39] !== null) ? (string) $row[$startcol + 39] : null;
            $this->pekerjaan_suami_istri = ($row[$startcol + 40] !== null) ? (int) $row[$startcol + 40] : null;
            $this->tmt_pns = ($row[$startcol + 41] !== null) ? (string) $row[$startcol + 41] : null;
            $this->sudah_lisensi_kepala_sekolah = ($row[$startcol + 42] !== null) ? (string) $row[$startcol + 42] : null;
            $this->jumlah_sekolah_binaan = ($row[$startcol + 43] !== null) ? (int) $row[$startcol + 43] : null;
            $this->pernah_diklat_kepengawasan = ($row[$startcol + 44] !== null) ? (string) $row[$startcol + 44] : null;
            $this->nm_wp = ($row[$startcol + 45] !== null) ? (string) $row[$startcol + 45] : null;
            $this->status_data = ($row[$startcol + 46] !== null) ? (int) $row[$startcol + 46] : null;
            $this->karpeg = ($row[$startcol + 47] !== null) ? (string) $row[$startcol + 47] : null;
            $this->karpas = ($row[$startcol + 48] !== null) ? (string) $row[$startcol + 48] : null;
            $this->mampu_handle_kk = ($row[$startcol + 49] !== null) ? (int) $row[$startcol + 49] : null;
            $this->keahlian_braille = ($row[$startcol + 50] !== null) ? (string) $row[$startcol + 50] : null;
            $this->keahlian_bhs_isyarat = ($row[$startcol + 51] !== null) ? (string) $row[$startcol + 51] : null;
            $this->npwp = ($row[$startcol + 52] !== null) ? (string) $row[$startcol + 52] : null;
            $this->kewarganegaraan = ($row[$startcol + 53] !== null) ? (string) $row[$startcol + 53] : null;
            $this->id_bank = ($row[$startcol + 54] !== null) ? (string) $row[$startcol + 54] : null;
            $this->rekening_bank = ($row[$startcol + 55] !== null) ? (string) $row[$startcol + 55] : null;
            $this->rekening_atas_nama = ($row[$startcol + 56] !== null) ? (string) $row[$startcol + 56] : null;
            $this->blob_id = ($row[$startcol + 57] !== null) ? (string) $row[$startcol + 57] : null;
            $this->create_date = ($row[$startcol + 58] !== null) ? (string) $row[$startcol + 58] : null;
            $this->last_update = ($row[$startcol + 59] !== null) ? (string) $row[$startcol + 59] : null;
            $this->soft_delete = ($row[$startcol + 60] !== null) ? (string) $row[$startcol + 60] : null;
            $this->last_sync = ($row[$startcol + 61] !== null) ? (string) $row[$startcol + 61] : null;
            $this->updater_id = ($row[$startcol + 62] !== null) ? (string) $row[$startcol + 62] : null;
            $this->resetModified();
            ...
            return $startcol + 63; // 63 = PtkPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray($keyType = BasePeer::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[10] => $this->getNuks(),
            $keys[11] => $this->getStatusKepegawaianId(),
            $keys[12] => $this->getJenisPtkId(),
            $keys[13] => $this->getPengawasBidangStudiId(),
            $keys[14] => $this->getAgamaId(),
            $keys[15] => $this->getAlamatJalan(),
            $keys[16] => $this->getRt(),
            $keys[17] => $this->getRw(),
            $keys[18] => $this->getNamaDusun(),
            $keys[19] => $this->getDesaKelurahan(),
            $keys[20] => $this->getKodeWilayah(),
            $keys[21] => $this->getKodePos(),
            $keys[22] => $this->getLintang(),
            $keys[23] => $this->getBujur(),
            $keys[24] => $this->getNoTeleponRumah(),
            $keys[25] => $this->getNoHp(),
            $keys[26] => $this->getEmail(),
            $keys[27] => $this->getStatusKeaktifanId(),
            $keys[28] => $this->getSkCpns(),
            $keys[29] => $this->getTglCpns(),
            $keys[30] => $this->getSkPengangkatan(),
            $keys[31] => $this->getTmtPengangkatan(),
            $keys[32] => $this->getLembagaPengangkatId(),
            $keys[33] => $this->getPangkatGolonganId(),
            $keys[34] => $this->getKeahlianLaboratoriumId(),
            $keys[35] => $this->getSumberGajiId(),
            $keys[36] => $this->getNamaIbuKandung(),
            $keys[37] => $this->getStatusPerkawinan(),
            $keys[38] => $this->getNamaSuamiIstri(),
            $keys[39] => $this->getNipSuamiIstri(),
            $keys[40] => $this->getPekerjaanSuamiIstri(),
            $keys[41] => $this->getTmtPns(),
            $keys[42] => $this->getSudahLisensiKepalaSekolah(),
            $keys[43] => $this->getJumlahSekolahBinaan(),
            $keys[44] => $this->getPernahDiklatKepengawasan(),
            $keys[45] => $this->getNmWp(),
            $keys[46] => $this->getStatusData(),
            $keys[47] => $this->getKarpeg(),
            $keys[48] => $this->getKarpas(),
            $keys[49] => $this->getMampuHandleKk(),
            $keys[50] => $this->getKeahlianBraille(),
            $keys[51] => $this->getKeahlianBhsIsyarat(),
            $keys[52] => $this->getNpwp(),
            $keys[53] => $this->getKewarganegaraan(),
            $keys[54] => $this->getIdBank(),
            $keys[55] => $this->getRekeningBank(),
            $keys[56] => $this->getRekeningAtasNama(),
            $keys[57] => $this->getBlobId(),
            $keys[58] => $this->getCreateDate(),
            $keys[59] => $this->getLastUpdate(),
            $keys[60] => $this->getSoftDelete(),
            $keys[61] => $this->getLastSync(),
            $keys[62] => $this->getUpdaterId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[10], $arr)) $this->setNuks($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setStatusKepegawaianId($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setJenisPtkId($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setPengawasBidangStudiId($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setAgamaId($arr[$keys[14]]);
        if (array_key_exists($keys[15], $arr)) $this->setAlamatJalan($arr[$keys[15]]);
        if (array_key_exists($keys[16], $arr)) $this->setRt($arr[$keys[16]]);
        if (array_key_exists($keys[17], $arr)) $this->setRw($arr[$keys[17]]);
        if (array_key_exists($keys[18], $arr)) $this->setNamaDusun($arr[$keys[18]]);
        if (array_key_exists($keys[19], $arr)) $this->setDesaKelurahan($arr[$keys[19]]);
        if (array_key_exists($keys[20], $arr)) $this->setKodeWilayah($arr[$keys[20]]);
        if (array_key_exists($keys[21], $arr)) $this->setKodePos($arr[$keys[21]]);
        if (array_key_exists($keys[22], $arr)) $this->setLintang($arr[$keys[22]]);
        if (array_key_exists($keys[23], $arr)) $this->setBujur($arr[$keys[23]]);
        if (array_key_exists($keys[24], $arr)) $this->setNoTeleponRumah($arr[$keys[24]]);
        if (array_key_exists($keys[25], $arr)) $this->setNoHp($arr[$keys[25]]);
        if (array_key_exists($keys[26], $arr)) $this->setEmail($arr[$keys[26]]);
        if (array_key_exists($keys[27], $arr)) $this->setStatusKeaktifanId($arr[$keys[27]]);
        if (array_key_exists($keys[28], $arr)) $this->setSkCpns($arr[$keys[28]]);
        if (array_key_exists($keys[29], $arr)) $this->setTglCpns($arr[$keys[29]]);
        if (array_key_exists($keys[30], $arr)) $this->setSkPengangkatan($arr[$keys[30]]);
        if (array_key_exists($keys[31], $arr)) $this->setTmtPengangkatan($arr[$keys[31]]);
        if (array_key_exists($keys[32], $arr)) $this->setLembagaPengangkatId($arr[$keys[32]]);
        if (array_key_exists($keys[33], $arr)) $this->setPangkatGolonganId($arr[$keys[33]]);
        if (array_key_exists($keys[34], $arr)) $this->setKeahlianLaboratoriumId($arr[$keys[34]]);
        if (array_key_exists($keys[35], $arr)) $this->setSumberGajiId($arr[$keys[35]]);
        if (array_key_exists($keys[36], $arr)) $this->setNamaIbuKandung($arr[$keys[36]]);
        if (array_key_exists($keys[37], $arr)) $this->setStatusPerkawinan($arr[$keys[37]]);
        if (array_key_exists($keys[38], $arr)) $this->setNamaSuamiIstri($arr[$keys[38]]);
        if (array_key_exists($keys[39], $arr)) $this->setNipSuamiIstri($arr[$keys[39]]);
        if (array_key_exists($keys[40], $arr)) $this->setPekerjaanSuamiIstri($arr[$keys[40]]);
        if (array_key_exists($keys[41], $arr)) $this->setTmtPns($arr[$keys[41]]);
        if (array_key_exists($keys[42], $arr)) $this->setSudahLisensiKepalaSekolah($arr[$keys[42]]);
        if (array_key_exists($keys[43], $arr)) $this->setJumlahSekolahBinaan($arr[$keys[43]]);
        if (array_key_exists($keys[44], $arr)) $this->setPernahDiklatKepengawasan($arr[$keys[44]]);
        if (array_key_exists($keys[45], $arr)) $this->setNmWp($arr[$keys[45]]);
        if (array_key_exists($keys[46], $arr)) $this->setStatusData($arr[$keys[46]]);
        if (array_key_exists($keys[47], $arr)) $this->setKarpeg($arr[$keys[47]]);
        if (array_key_exists($keys[48], $arr)) $this->setKarpas($arr[$keys[48]]);
        if (array_key_exists($keys[49], $arr)) $this->setMampuHandleKk($arr[$keys[49]]);
        if (array_key_exists($keys[50], $arr)) $this->setKeahlianBraille($arr[$keys[50]]);
        if (array_key_exists($keys[51], $arr)) $this->setKeahlianBhsIsyarat($arr[$keys[51]]);
        if (array_key_exists($keys[52], $arr)) $this->setNpwp($arr[$keys[52]]);
        if (array_key_exists($keys[53], $arr)) $this->setKewarganegaraan($arr[$keys[53]]);
        if (array_key_exists($keys[54], $arr)) $this->setIdBank($arr[$keys[54]]);
        if (array_key_exists($keys[55], $arr)) $this->setRekeningBank($arr[$keys[55]]);
        if (array_key_exists($keys[56], $arr)) $this->setRekeningAtasNama($arr[$keys[56]]);
        if (array_key_exists($keys[57], $arr)) $this->setBlobId($arr[$keys[57]]);
        if (array_key_exists($keys[58], $arr)) $this->setCreateDate($arr[$keys[58]]);
        if (array_key_exists($keys[59], $arr)) $this->setLastUpdate($arr[$keys[59]]);
        if (array_key_exists($keys[60], $arr)) $this->setSoftDelete($arr[$keys[60]]);
        if (array_key_exists($keys[61], $arr)) $this->setLastSync($arr[$keys[61]]);
        if (array_key_exists($keys[62], $arr)) $this->setUpdaterId($arr[$keys[62]]);
    }
