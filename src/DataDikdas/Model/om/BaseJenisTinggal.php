...
/**
 * Base class that represents a row from the 'ref.jenis_tinggal' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseJenisTinggal extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\JenisTinggalPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        JenisTinggalPeer
     */
    ...
    /**
     * Initializes internal state of BaseJenisTinggal object.
     * @see        applyDefaults()
     */
     ...
     * @return JenisTinggal The current object (for fluent API support)
     */
    public function setJenisTinggalId($v)
    {
        ...
        if ($this->jenis_tinggal_id !== $v) {
            ...
            $this->modifiedColumns[] = JenisTinggalPeer::JENIS_TINGGAL_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = JenisTinggalPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisTinggalPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisTinggalPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisTinggalPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = JenisTinggalPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->jenis_tinggal_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = JenisTinggalPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JenisTinggal object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JenisTinggalPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getConnection(JenisTinggalPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
        }

        $con->beginTransaction();
        try {
            $deleteQuery = JenisTinggalQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JenisTinggalPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JenisTinggalPeer::JENIS_TINGGAL_ID)) {
            $modifiedColumns[':p' . $index++]  = '"jenis_tinggal_id"';
        }
        if ($this->isColumnModified(JenisTinggalPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(JenisTinggalPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(JenisTinggalPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(JenisTinggalPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(JenisTinggalPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."jenis_tinggal" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JenisTinggalPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JenisTinggalPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['JenisTinggal'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JenisTinggal'][$this->getPrimaryKey()] = true;
        $keys = JenisTinggalPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getJenisTinggalId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setJenisTinggalId($arr[$keys[0]]);
    ...
    {
        $criteria = new Criteria(JenisTinggalPeer::DATABASE_NAME);

        if ($this->isColumnModified(JenisTinggalPeer::JENIS_TINGGAL_ID)) $criteria->add(JenisTinggalPeer::JENIS_TINGGAL_ID, $this->jenis_tinggal_id);
        if ($this->isColumnModified(JenisTinggalPeer::NAMA)) $criteria->add(JenisTinggalPeer::NAMA, $this->nama);
        if ($this->isColumnModified(JenisTinggalPeer::CREATE_DATE)) $criteria->add(JenisTinggalPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(JenisTinggalPeer::LAST_UPDATE)) $criteria->add(JenisTinggalPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(JenisTinggalPeer::EXPIRED_DATE)) $criteria->add(JenisTinggalPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(JenisTinggalPeer::LAST_SYNC)) $criteria->add(JenisTinggalPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(JenisTinggalPeer::DATABASE_NAME);
        $criteria->add(JenisTinggalPeer::JENIS_TINGGAL_ID, $this->jenis_tinggal_id);
    ...
    /**
     * Generic method to set the primary key (jenis_tinggal_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getJenisTinggalId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of JenisTinggal (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setJenisTinggalId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JenisTinggal Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return JenisTinggalPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new JenisTinggalPeer();
        }
     ...
     * If this JenisTinggal is new, it will return
    ...
    public function setPesertaDidiks(PropelCollection $pesertaDidiks, PropelPDO $con = null)
    {
        ...
        foreach ($pesertaDidiksToDelete as $pesertaDidikRemoved) {
            $pesertaDidikRemoved->setJenisTinggal(null);
        }
    ...
    protected function doAddPesertaDidik($pesertaDidik)
    {
        ...
        $pesertaDidik->setJenisTinggal($this);
    }
    ...
    public function removePesertaDidik($pesertaDidik)
    {
        if ($this->getPesertaDidiks()->contains($pesertaDidik)) {
            ...
            $pesertaDidik->setJenisTinggal(null);
        }
     ...
     * Otherwise if this JenisTinggal is new, it will return
     * an empty collection; or if this JenisTinggal has previously
     * been saved, it will retrieve related PesertaDidiks from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in JenisTinggal.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(JenisTinggalPeer::DEFAULT_STRING_FORMAT);
    }
