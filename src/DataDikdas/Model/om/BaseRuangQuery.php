...
abstract class BaseRuangQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "id_ruang", "jenis_prasarana_id", "sekolah_id", "id_bangunan", "kd_ruang", "nm_ruang", "lantai", "panjang", "lebar", "reg_pras", "kapasitas", "luas_ruang", "luas_plester_m2", "luas_plafon_m2", "luas_dinding_m2", "luas_daun_jendela_m2", "luas_daun_pintu_m2", "panj_kusen_m", "luas_tutup_lantai_m2", "panj_inst_listrik_m", "jml_inst_listrik", "panj_inst_air_m", "jml_inst_air", "panj_drainase_m", "luas_finish_struktur_m2", "luas_finish_plafon_m2", "luas_finish_dinding_m2", "luas_finish_kpj_m2", "create_date", "last_update", "soft_delete", "last_sync", "updater_id" FROM "ruang" WHERE "id_ruang" = :p0';
        try {
