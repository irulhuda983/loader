...
/**
 * Base class that represents a row from the 'buku_pelajaran' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseBukuPelajaran extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\BukuPelajaranPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        BukuPelajaranPeer
     */
    ...
    /**
     * Initializes internal state of BaseBukuPelajaran object.
     * @see        applyDefaults()
     */
     ...
     * @return BukuPelajaran The current object (for fluent API support)
     */
    public function setIdBiblio($v)
    {
        ...
        if ($this->id_biblio !== $v) {
            $this->id_biblio = $v;
            $this->modifiedColumns[] = BukuPelajaranPeer::ID_BIBLIO;
        }
    ...
    public function setPembelajaranId($v)
    {
        ...
        if ($this->pembelajaran_id !== $v) {
            ...
            $this->modifiedColumns[] = BukuPelajaranPeer::PEMBELAJARAN_ID;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BukuPelajaranPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BukuPelajaranPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = BukuPelajaranPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = BukuPelajaranPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = BukuPelajaranPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = BukuPelajaranPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BukuPelajaran object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BukuPelajaranPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BukuPelajaranQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BukuPelajaranPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BukuPelajaranPeer::ID_BIBLIO)) {
            $modifiedColumns[':p' . $index++]  = '"id_biblio"';
        }
        if ($this->isColumnModified(BukuPelajaranPeer::PEMBELAJARAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"pembelajaran_id"';
        }
        if ($this->isColumnModified(BukuPelajaranPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(BukuPelajaranPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(BukuPelajaranPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(BukuPelajaranPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(BukuPelajaranPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "buku_pelajaran" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BukuPelajaranPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BukuPelajaranPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BukuPelajaran'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BukuPelajaran'][serialize($this->getPrimaryKey())] = true;
        $keys = BukuPelajaranPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BukuPelajaranPeer::ID_BIBLIO)) $criteria->add(BukuPelajaranPeer::ID_BIBLIO, $this->id_biblio);
        if ($this->isColumnModified(BukuPelajaranPeer::PEMBELAJARAN_ID)) $criteria->add(BukuPelajaranPeer::PEMBELAJARAN_ID, $this->pembelajaran_id);
        if ($this->isColumnModified(BukuPelajaranPeer::CREATE_DATE)) $criteria->add(BukuPelajaranPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(BukuPelajaranPeer::LAST_UPDATE)) $criteria->add(BukuPelajaranPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(BukuPelajaranPeer::SOFT_DELETE)) $criteria->add(BukuPelajaranPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(BukuPelajaranPeer::LAST_SYNC)) $criteria->add(BukuPelajaranPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(BukuPelajaranPeer::UPDATER_ID)) $criteria->add(BukuPelajaranPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(BukuPelajaranPeer::DATABASE_NAME);
        $criteria->add(BukuPelajaranPeer::ID_BIBLIO, $this->id_biblio);
        $criteria->add(BukuPelajaranPeer::PEMBELAJARAN_ID, $this->pembelajaran_id);
    ...
    {
        $pks = array();
        $pks[0] = $this->getIdBiblio();
        $pks[1] = $this->getPembelajaranId();
    ...
    {
        $this->setIdBiblio($keys[0]);
        $this->setPembelajaranId($keys[1]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdBiblio()) && (null === $this->getPembelajaranId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of BukuPelajaran (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BukuPelajaran Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BukuPelajaranPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BukuPelajaranPeer();
        }
    ...
    public function getPembelajaran(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPembelajaran === null && (($this->pembelajaran_id !== "" && $this->pembelajaran_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPembelajaran->addBukuPelajarans($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(BukuPelajaranPeer::DEFAULT_STRING_FORMAT);
    }
