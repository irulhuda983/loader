...
/**
 * Base class that represents a row from the 'ref.alasan_layak_pip' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseAlasanLayakPip extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\AlasanLayakPipPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        AlasanLayakPipPeer
     */
    ...
    /**
     * The value for the alasan_layak_pip field.
     * @var        string
     */
    protected $alasan_layak_pip;
    ...
    /**
     * Initializes internal state of BaseAlasanLayakPip object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [alasan_layak_pip] column value.
     * 
     * @return string
     */
    public function getAlasanLayakPip()
    {
        return $this->alasan_layak_pip;
    }
     ...
     * @return AlasanLayakPip The current object (for fluent API support)
     */
    public function setIdLayakPip($v)
    {
        ...
        if ($this->id_layak_pip !== $v) {
            $this->id_layak_pip = $v;
            $this->modifiedColumns[] = AlasanLayakPipPeer::ID_LAYAK_PIP;
        }
    ...
    /**
     * Set the value of [alasan_layak_pip] column.
     * 
     * @param string $v new value
     * @return AlasanLayakPip The current object (for fluent API support)
     */
    public function setAlasanLayakPip($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->alasan_layak_pip !== $v) {
            $this->alasan_layak_pip = $v;
            $this->modifiedColumns[] = AlasanLayakPipPeer::ALASAN_LAYAK_PIP;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AlasanLayakPipPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AlasanLayakPipPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AlasanLayakPipPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = AlasanLayakPipPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_layak_pip = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            $this->alasan_layak_pip = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 6; // 6 = AlasanLayakPipPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating AlasanLayakPip object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AlasanLayakPipPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AlasanLayakPipQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AlasanLayakPipPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AlasanLayakPipPeer::ID_LAYAK_PIP)) {
            $modifiedColumns[':p' . $index++]  = '"id_layak_pip"';
        }
        if ($this->isColumnModified(AlasanLayakPipPeer::ALASAN_LAYAK_PIP)) {
            $modifiedColumns[':p' . $index++]  = '"alasan_layak_pip"';
        }
        if ($this->isColumnModified(AlasanLayakPipPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(AlasanLayakPipPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(AlasanLayakPipPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(AlasanLayakPipPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."alasan_layak_pip" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"id_layak_pip"':						
                        ...
                        break;
                    case '"alasan_layak_pip"':						
                        $stmt->bindValue($identifier, $this->alasan_layak_pip, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AlasanLayakPipPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AlasanLayakPipPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['AlasanLayakPip'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AlasanLayakPip'][$this->getPrimaryKey()] = true;
        $keys = AlasanLayakPipPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdLayakPip(),
            $keys[1] => $this->getAlasanLayakPip(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdLayakPip($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setAlasanLayakPip($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AlasanLayakPipPeer::ID_LAYAK_PIP)) $criteria->add(AlasanLayakPipPeer::ID_LAYAK_PIP, $this->id_layak_pip);
        if ($this->isColumnModified(AlasanLayakPipPeer::ALASAN_LAYAK_PIP)) $criteria->add(AlasanLayakPipPeer::ALASAN_LAYAK_PIP, $this->alasan_layak_pip);
        if ($this->isColumnModified(AlasanLayakPipPeer::CREATE_DATE)) $criteria->add(AlasanLayakPipPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(AlasanLayakPipPeer::LAST_UPDATE)) $criteria->add(AlasanLayakPipPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(AlasanLayakPipPeer::EXPIRED_DATE)) $criteria->add(AlasanLayakPipPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(AlasanLayakPipPeer::LAST_SYNC)) $criteria->add(AlasanLayakPipPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(AlasanLayakPipPeer::DATABASE_NAME);
        $criteria->add(AlasanLayakPipPeer::ID_LAYAK_PIP, $this->id_layak_pip);
    ...
    /**
     * Generic method to set the primary key (id_layak_pip column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdLayakPip();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of AlasanLayakPip (or compatible) type.
    ...
    {
        $copyObj->setAlasanLayakPip($this->getAlasanLayakPip());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdLayakPip(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return AlasanLayakPip Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return AlasanLayakPipPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new AlasanLayakPipPeer();
        }
     ...
     * If this AlasanLayakPip is new, it will return
    ...
    public function setPesertaDidiks(PropelCollection $pesertaDidiks, PropelPDO $con = null)
    {
        ...
        foreach ($pesertaDidiksToDelete as $pesertaDidikRemoved) {
            $pesertaDidikRemoved->setAlasanLayakPip(null);
        }
    ...
    protected function doAddPesertaDidik($pesertaDidik)
    {
        ...
        $pesertaDidik->setAlasanLayakPip($this);
    }
    ...
    public function removePesertaDidik($pesertaDidik)
    {
        if ($this->getPesertaDidiks()->contains($pesertaDidik)) {
            ...
            $pesertaDidik->setAlasanLayakPip(null);
        }
     ...
     * Otherwise if this AlasanLayakPip is new, it will return
     * an empty collection; or if this AlasanLayakPip has previously
     * been saved, it will retrieve related PesertaDidiks from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in AlasanLayakPip.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(AlasanLayakPipPeer::DEFAULT_STRING_FORMAT);
    }
