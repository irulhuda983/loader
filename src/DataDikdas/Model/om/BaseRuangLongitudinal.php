...
abstract class BaseRuangLongitudinal extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->rusak_lisplang_talang = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->ket_lisplang_talang = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->rusak_rangka_plafon = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->ket_rangka_plafon = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->rusak_tutup_plafon = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->ket_tutup_plafon = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->rusak_bata_dinding = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->ket_bata_dinding = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->rusak_plester_dinding = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->ket_plester_dinding = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->rusak_daun_jendela = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
            $this->ket_daun_jendela = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
            $this->rusak_daun_pintu = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
            $this->ket_daun_pintu = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
            $this->rusak_kusen = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
            $this->ket_kusen = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
            $this->rusak_tutup_lantai = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
            $this->ket_penutup_lantai = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
            $this->rusak_inst_listrik = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
            $this->ket_inst_listrik = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
            $this->rusak_inst_air = ($row[$startcol + 23] !== null) ? (string) $row[$startcol + 23] : null;
            $this->ket_inst_air = ($row[$startcol + 24] !== null) ? (string) $row[$startcol + 24] : null;
            $this->rusak_drainase = ($row[$startcol + 25] !== null) ? (string) $row[$startcol + 25] : null;
            $this->ket_drainase = ($row[$startcol + 26] !== null) ? (string) $row[$startcol + 26] : null;
            $this->rusak_finish_struktur = ($row[$startcol + 27] !== null) ? (string) $row[$startcol + 27] : null;
            $this->ket_finish_struktur = ($row[$startcol + 28] !== null) ? (string) $row[$startcol + 28] : null;
            $this->rusak_finish_plafon = ($row[$startcol + 29] !== null) ? (string) $row[$startcol + 29] : null;
            $this->ket_finish_plafon = ($row[$startcol + 30] !== null) ? (string) $row[$startcol + 30] : null;
            $this->rusak_finish_dinding = ($row[$startcol + 31] !== null) ? (string) $row[$startcol + 31] : null;
            $this->ket_finish_dinding = ($row[$startcol + 32] !== null) ? (string) $row[$startcol + 32] : null;
            $this->rusak_finish_kpj = ($row[$startcol + 33] !== null) ? (string) $row[$startcol + 33] : null;
            $this->ket_finish_kpj = ($row[$startcol + 34] !== null) ? (string) $row[$startcol + 34] : null;
            $this->berfungsi = ($row[$startcol + 35] !== null) ? (string) $row[$startcol + 35] : null;
            $this->create_date = ($row[$startcol + 36] !== null) ? (string) $row[$startcol + 36] : null;
            $this->last_update = ($row[$startcol + 37] !== null) ? (string) $row[$startcol + 37] : null;
            $this->soft_delete = ($row[$startcol + 38] !== null) ? (string) $row[$startcol + 38] : null;
            $this->last_sync = ($row[$startcol + 39] !== null) ? (string) $row[$startcol + 39] : null;
            $this->updater_id = ($row[$startcol + 40] !== null) ? (string) $row[$startcol + 40] : null;
            $this->resetModified();
            ...
            return $startcol + 41; // 41 = RuangLongitudinalPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray($keyType = BasePeer::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getRusakLisplangTalang(),
            $keys[4] => $this->getKetLisplangTalang(),
            $keys[5] => $this->getRusakRangkaPlafon(),
            $keys[6] => $this->getKetRangkaPlafon(),
            $keys[7] => $this->getRusakTutupPlafon(),
            $keys[8] => $this->getKetTutupPlafon(),
            $keys[9] => $this->getRusakBataDinding(),
            $keys[10] => $this->getKetBataDinding(),
            $keys[11] => $this->getRusakPlesterDinding(),
            $keys[12] => $this->getKetPlesterDinding(),
            $keys[13] => $this->getRusakDaunJendela(),
            $keys[14] => $this->getKetDaunJendela(),
            $keys[15] => $this->getRusakDaunPintu(),
            $keys[16] => $this->getKetDaunPintu(),
            $keys[17] => $this->getRusakKusen(),
            $keys[18] => $this->getKetKusen(),
            $keys[19] => $this->getRusakTutupLantai(),
            $keys[20] => $this->getKetPenutupLantai(),
            $keys[21] => $this->getRusakInstListrik(),
            $keys[22] => $this->getKetInstListrik(),
            $keys[23] => $this->getRusakInstAir(),
            $keys[24] => $this->getKetInstAir(),
            $keys[25] => $this->getRusakDrainase(),
            $keys[26] => $this->getKetDrainase(),
            $keys[27] => $this->getRusakFinishStruktur(),
            $keys[28] => $this->getKetFinishStruktur(),
            $keys[29] => $this->getRusakFinishPlafon(),
            $keys[30] => $this->getKetFinishPlafon(),
            $keys[31] => $this->getRusakFinishDinding(),
            $keys[32] => $this->getKetFinishDinding(),
            $keys[33] => $this->getRusakFinishKpj(),
            $keys[34] => $this->getKetFinishKpj(),
            $keys[35] => $this->getBerfungsi(),
            $keys[36] => $this->getCreateDate(),
            $keys[37] => $this->getLastUpdate(),
            $keys[38] => $this->getSoftDelete(),
            $keys[39] => $this->getLastSync(),
            $keys[40] => $this->getUpdaterId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setRusakLisplangTalang($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setKetLisplangTalang($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setRusakRangkaPlafon($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setKetRangkaPlafon($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setRusakTutupPlafon($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setKetTutupPlafon($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setRusakBataDinding($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setKetBataDinding($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setRusakPlesterDinding($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setKetPlesterDinding($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setRusakDaunJendela($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setKetDaunJendela($arr[$keys[14]]);
        if (array_key_exists($keys[15], $arr)) $this->setRusakDaunPintu($arr[$keys[15]]);
        if (array_key_exists($keys[16], $arr)) $this->setKetDaunPintu($arr[$keys[16]]);
        if (array_key_exists($keys[17], $arr)) $this->setRusakKusen($arr[$keys[17]]);
        if (array_key_exists($keys[18], $arr)) $this->setKetKusen($arr[$keys[18]]);
        if (array_key_exists($keys[19], $arr)) $this->setRusakTutupLantai($arr[$keys[19]]);
        if (array_key_exists($keys[20], $arr)) $this->setKetPenutupLantai($arr[$keys[20]]);
        if (array_key_exists($keys[21], $arr)) $this->setRusakInstListrik($arr[$keys[21]]);
        if (array_key_exists($keys[22], $arr)) $this->setKetInstListrik($arr[$keys[22]]);
        if (array_key_exists($keys[23], $arr)) $this->setRusakInstAir($arr[$keys[23]]);
        if (array_key_exists($keys[24], $arr)) $this->setKetInstAir($arr[$keys[24]]);
        if (array_key_exists($keys[25], $arr)) $this->setRusakDrainase($arr[$keys[25]]);
        if (array_key_exists($keys[26], $arr)) $this->setKetDrainase($arr[$keys[26]]);
        if (array_key_exists($keys[27], $arr)) $this->setRusakFinishStruktur($arr[$keys[27]]);
        if (array_key_exists($keys[28], $arr)) $this->setKetFinishStruktur($arr[$keys[28]]);
        if (array_key_exists($keys[29], $arr)) $this->setRusakFinishPlafon($arr[$keys[29]]);
        if (array_key_exists($keys[30], $arr)) $this->setKetFinishPlafon($arr[$keys[30]]);
        if (array_key_exists($keys[31], $arr)) $this->setRusakFinishDinding($arr[$keys[31]]);
        if (array_key_exists($keys[32], $arr)) $this->setKetFinishDinding($arr[$keys[32]]);
        if (array_key_exists($keys[33], $arr)) $this->setRusakFinishKpj($arr[$keys[33]]);
        if (array_key_exists($keys[34], $arr)) $this->setKetFinishKpj($arr[$keys[34]]);
        if (array_key_exists($keys[35], $arr)) $this->setBerfungsi($arr[$keys[35]]);
        if (array_key_exists($keys[36], $arr)) $this->setCreateDate($arr[$keys[36]]);
        if (array_key_exists($keys[37], $arr)) $this->setLastUpdate($arr[$keys[37]]);
        if (array_key_exists($keys[38], $arr)) $this->setSoftDelete($arr[$keys[38]]);
        if (array_key_exists($keys[39], $arr)) $this->setLastSync($arr[$keys[39]]);
        if (array_key_exists($keys[40], $arr)) $this->setUpdaterId($arr[$keys[40]]);
    }
