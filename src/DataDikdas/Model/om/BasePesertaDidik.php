...
abstract class BasePesertaDidik extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->create_date = ($row[$startcol + 60] !== null) ? (string) $row[$startcol + 60] : null;
            $this->last_update = ($row[$startcol + 61] !== null) ? (string) $row[$startcol + 61] : null;
            $this->soft_delete = ($row[$startcol + 62] !== null) ? (string) $row[$startcol + 62] : null;
            $this->last_sync = ($row[$startcol + 63] !== null) ? (string) $row[$startcol + 63] : null;
            $this->updater_id = ($row[$startcol + 64] !== null) ? (string) $row[$startcol + 64] : null;
            $this->resetModified();
            ...
            return $startcol + 65; // 65 = PesertaDidikPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray($keyType = BasePeer::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[60] => $this->getCreateDate(),
            $keys[61] => $this->getLastUpdate(),
            $keys[62] => $this->getSoftDelete(),
            $keys[63] => $this->getLastSync(),
            $keys[64] => $this->getUpdaterId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[60], $arr)) $this->setCreateDate($arr[$keys[60]]);
        if (array_key_exists($keys[61], $arr)) $this->setLastUpdate($arr[$keys[61]]);
        if (array_key_exists($keys[62], $arr)) $this->setSoftDelete($arr[$keys[62]]);
        if (array_key_exists($keys[63], $arr)) $this->setLastSync($arr[$keys[63]]);
        if (array_key_exists($keys[64], $arr)) $this->setUpdaterId($arr[$keys[64]]);
    }
