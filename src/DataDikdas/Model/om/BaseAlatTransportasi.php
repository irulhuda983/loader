...
/**
 * Base class that represents a row from the 'ref.alat_transportasi' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseAlatTransportasi extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\AlatTransportasiPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        AlatTransportasiPeer
     */
    ...
    /**
     * Initializes internal state of BaseAlatTransportasi object.
     * @see        applyDefaults()
     */
     ...
     * @return AlatTransportasi The current object (for fluent API support)
     */
    public function setAlatTransportasiId($v)
    {
        ...
        if ($this->alat_transportasi_id !== $v) {
            ...
            $this->modifiedColumns[] = AlatTransportasiPeer::ALAT_TRANSPORTASI_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = AlatTransportasiPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AlatTransportasiPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AlatTransportasiPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AlatTransportasiPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = AlatTransportasiPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->alat_transportasi_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = AlatTransportasiPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating AlatTransportasi object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AlatTransportasiPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getConnection(AlatTransportasiPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
        }

        $con->beginTransaction();
        try {
            $deleteQuery = AlatTransportasiQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AlatTransportasiPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AlatTransportasiPeer::ALAT_TRANSPORTASI_ID)) {
            $modifiedColumns[':p' . $index++]  = '"alat_transportasi_id"';
        }
        if ($this->isColumnModified(AlatTransportasiPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(AlatTransportasiPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(AlatTransportasiPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(AlatTransportasiPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(AlatTransportasiPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."alat_transportasi" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AlatTransportasiPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AlatTransportasiPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['AlatTransportasi'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AlatTransportasi'][$this->getPrimaryKey()] = true;
        $keys = AlatTransportasiPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getAlatTransportasiId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setAlatTransportasiId($arr[$keys[0]]);
    ...
    {
        $criteria = new Criteria(AlatTransportasiPeer::DATABASE_NAME);

        if ($this->isColumnModified(AlatTransportasiPeer::ALAT_TRANSPORTASI_ID)) $criteria->add(AlatTransportasiPeer::ALAT_TRANSPORTASI_ID, $this->alat_transportasi_id);
        if ($this->isColumnModified(AlatTransportasiPeer::NAMA)) $criteria->add(AlatTransportasiPeer::NAMA, $this->nama);
        if ($this->isColumnModified(AlatTransportasiPeer::CREATE_DATE)) $criteria->add(AlatTransportasiPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(AlatTransportasiPeer::LAST_UPDATE)) $criteria->add(AlatTransportasiPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(AlatTransportasiPeer::EXPIRED_DATE)) $criteria->add(AlatTransportasiPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(AlatTransportasiPeer::LAST_SYNC)) $criteria->add(AlatTransportasiPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(AlatTransportasiPeer::DATABASE_NAME);
        $criteria->add(AlatTransportasiPeer::ALAT_TRANSPORTASI_ID, $this->alat_transportasi_id);
    ...
    /**
     * Generic method to set the primary key (alat_transportasi_id column).
     *
    ...
    {
        $this->setAlatTransportasiId($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getAlatTransportasiId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of AlatTransportasi (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setAlatTransportasiId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return AlatTransportasi Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return AlatTransportasiPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new AlatTransportasiPeer();
        }
     ...
     * If this AlatTransportasi is new, it will return
    ...
    public function setPesertaDidiks(PropelCollection $pesertaDidiks, PropelPDO $con = null)
    {
        ...
        foreach ($pesertaDidiksToDelete as $pesertaDidikRemoved) {
            $pesertaDidikRemoved->setAlatTransportasi(null);
        }
    ...
    protected function doAddPesertaDidik($pesertaDidik)
    {
        ...
        $pesertaDidik->setAlatTransportasi($this);
    }
    ...
    public function removePesertaDidik($pesertaDidik)
    {
        if ($this->getPesertaDidiks()->contains($pesertaDidik)) {
            ...
            $pesertaDidik->setAlatTransportasi(null);
        }
     ...
     * Otherwise if this AlatTransportasi is new, it will return
     * an empty collection; or if this AlatTransportasi has previously
     * been saved, it will retrieve related PesertaDidiks from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in AlatTransportasi.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(AlatTransportasiPeer::DEFAULT_STRING_FORMAT);
    }
