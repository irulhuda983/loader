...
/**
 * Base class that represents a row from the 'paspor_ptk' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BasePasporPtk extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\PasporPtkPeer';
    ...
    /**
     * Initializes internal state of BasePasporPtk object.
     * @see        applyDefaults()
     */
     ...
     * @return PasporPtk The current object (for fluent API support)
     */
    public function setNoPaspor($v)
    {
        ...
        if ($this->no_paspor !== $v) {
            $this->no_paspor = $v;
            $this->modifiedColumns[] = PasporPtkPeer::NO_PASPOR;
        }
    ...
    public function setPtkId($v)
    {
        ...
        if ($this->ptk_id !== $v) {
            $this->ptk_id = $v;
            $this->modifiedColumns[] = PasporPtkPeer::PTK_ID;
        }
    ...
    public function setTempatTerbit($v)
    {
        ...
        if ($this->tempat_terbit !== $v) {
            ...
            $this->modifiedColumns[] = PasporPtkPeer::TEMPAT_TERBIT;
        }
    ...
    public function setTmtPaspor($v)
    {
        ...
        if ($this->tmt_paspor !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PasporPtkPeer::TMT_PASPOR;
            }
    ...
    public function setTstPaspor($v)
    {
        ...
        if ($this->tst_paspor !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PasporPtkPeer::TST_PASPOR;
            }
        } // if either are not null
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PasporPtkPeer::CREATE_DATE;
            }
        } // if either are not null
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PasporPtkPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = PasporPtkPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = PasporPtkPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = PasporPtkPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = PasporPtkPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PasporPtk object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PasporPtkPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PasporPtkQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PasporPtkPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PasporPtkPeer::NO_PASPOR)) {
            $modifiedColumns[':p' . $index++]  = '"no_paspor"';
        }
        if ($this->isColumnModified(PasporPtkPeer::PTK_ID)) {
            $modifiedColumns[':p' . $index++]  = '"ptk_id"';
        }
        if ($this->isColumnModified(PasporPtkPeer::TEMPAT_TERBIT)) {
            $modifiedColumns[':p' . $index++]  = '"tempat_terbit"';
        }
        if ($this->isColumnModified(PasporPtkPeer::TMT_PASPOR)) {
            $modifiedColumns[':p' . $index++]  = '"tmt_paspor"';
        }
        if ($this->isColumnModified(PasporPtkPeer::TST_PASPOR)) {
            $modifiedColumns[':p' . $index++]  = '"tst_paspor"';
        }
        if ($this->isColumnModified(PasporPtkPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(PasporPtkPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(PasporPtkPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(PasporPtkPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(PasporPtkPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "paspor_ptk" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PasporPtkPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PasporPtkPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PasporPtk'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PasporPtk'][$this->getPrimaryKey()] = true;
        $keys = PasporPtkPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PasporPtkPeer::NO_PASPOR)) $criteria->add(PasporPtkPeer::NO_PASPOR, $this->no_paspor);
        if ($this->isColumnModified(PasporPtkPeer::PTK_ID)) $criteria->add(PasporPtkPeer::PTK_ID, $this->ptk_id);
        if ($this->isColumnModified(PasporPtkPeer::TEMPAT_TERBIT)) $criteria->add(PasporPtkPeer::TEMPAT_TERBIT, $this->tempat_terbit);
        if ($this->isColumnModified(PasporPtkPeer::TMT_PASPOR)) $criteria->add(PasporPtkPeer::TMT_PASPOR, $this->tmt_paspor);
        if ($this->isColumnModified(PasporPtkPeer::TST_PASPOR)) $criteria->add(PasporPtkPeer::TST_PASPOR, $this->tst_paspor);
        if ($this->isColumnModified(PasporPtkPeer::CREATE_DATE)) $criteria->add(PasporPtkPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(PasporPtkPeer::LAST_UPDATE)) $criteria->add(PasporPtkPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(PasporPtkPeer::SOFT_DELETE)) $criteria->add(PasporPtkPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(PasporPtkPeer::LAST_SYNC)) $criteria->add(PasporPtkPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(PasporPtkPeer::UPDATER_ID)) $criteria->add(PasporPtkPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(PasporPtkPeer::DATABASE_NAME);
        $criteria->add(PasporPtkPeer::NO_PASPOR, $this->no_paspor);
     ...
     * objects.
     *
     * @param object $copyObj An object of PasporPtk (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PasporPtk Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PasporPtkPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PasporPtkPeer();
        }
    ...
    {
        return (string) $this->exportTo(PasporPtkPeer::DEFAULT_STRING_FORMAT);
    }
