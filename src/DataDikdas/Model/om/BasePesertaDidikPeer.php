...
abstract class BasePesertaDidikPeer
{
    ...
    public static function doSelectJoinAllExceptKebutuhanKhususRelatedByKebutuhanKhususIdAyah(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        AgamaPeer::addSelectColumns($criteria);
        $startcol7 = $startcol6 + AgamaPeer::NUM_HYDRATE_COLUMNS;

        PenghasilanPeer::addSelectColumns($criteria);
        $startcol8 = $startcol7 + PenghasilanPeer::NUM_HYDRATE_COLUMNS;

        JenisTinggalPeer::addSelectColumns($criteria);
        $startcol9 = $startcol8 + JenisTinggalPeer::NUM_HYDRATE_COLUMNS;

        AlatTransportasiPeer::addSelectColumns($criteria);
        $startcol10 = $startcol9 + AlatTransportasiPeer::NUM_HYDRATE_COLUMNS;

        PekerjaanPeer::addSelectColumns($criteria);
        $startcol11 = $startcol10 + PekerjaanPeer::NUM_HYDRATE_COLUMNS;

        JenjangPendidikanPeer::addSelectColumns($criteria);
        $startcol12 = $startcol11 + JenjangPendidikanPeer::NUM_HYDRATE_COLUMNS;

        PenghasilanPeer::addSelectColumns($criteria);
        $startcol13 = $startcol12 + PenghasilanPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = PesertaDidikPeer::getInstanceFromPool($key1))) {
                ...
                $key6 = AgamaPeer::getPrimaryKeyHashFromRow($row, $startcol6);
                if ($key6 !== null) {
                    $obj6 = AgamaPeer::getInstanceFromPool($key6);
                    if (!$obj6) {
                    ...
                    $obj6 = new $cls();
                    $obj6->hydrate($row, $startcol6);
                    AgamaPeer::addInstanceToPool($obj6, $key6);
                } // if $obj6 already loaded

                // Add the $obj1 (PesertaDidik) to the collection in $obj6 (Agama)
                $obj6->addPesertaDidik($obj1);
                ...
                $key7 = PenghasilanPeer::getPrimaryKeyHashFromRow($row, $startcol7);
                if ($key7 !== null) {
                    $obj7 = PenghasilanPeer::getInstanceFromPool($key7);
                    if (!$obj7) {
                    ...
                    $obj7 = new $cls();
                    $obj7->hydrate($row, $startcol7);
                    PenghasilanPeer::addInstanceToPool($obj7, $key7);
                } // if $obj7 already loaded

                // Add the $obj1 (PesertaDidik) to the collection in $obj7 (Penghasilan)
                $obj7->addPesertaDidikRelatedByPenghasilanIdAyah($obj1);

            } // if joined row is not null

                // Add objects for joined JenisTinggal rows

                $key8 = JenisTinggalPeer::getPrimaryKeyHashFromRow($row, $startcol8);
                if ($key8 !== null) {
                    $obj8 = JenisTinggalPeer::getInstanceFromPool($key8);
                    if (!$obj8) {
                    ...
                    $obj8 = new $cls();
                    $obj8->hydrate($row, $startcol8);
                    JenisTinggalPeer::addInstanceToPool($obj8, $key8);
                } // if $obj8 already loaded

                // Add the $obj1 (PesertaDidik) to the collection in $obj8 (JenisTinggal)
                $obj8->addPesertaDidik($obj1);

            } // if joined row is not null

                // Add objects for joined AlatTransportasi rows

                $key9 = AlatTransportasiPeer::getPrimaryKeyHashFromRow($row, $startcol9);
                if ($key9 !== null) {
                    $obj9 = AlatTransportasiPeer::getInstanceFromPool($key9);
                    if (!$obj9) {
                    ...
                    $obj9 = new $cls();
                    $obj9->hydrate($row, $startcol9);
                    AlatTransportasiPeer::addInstanceToPool($obj9, $key9);
                } // if $obj9 already loaded

                // Add the $obj1 (PesertaDidik) to the collection in $obj9 (AlatTransportasi)
                $obj9->addPesertaDidik($obj1);
                ...
                $key10 = PekerjaanPeer::getPrimaryKeyHashFromRow($row, $startcol10);
                if ($key10 !== null) {
                    $obj10 = PekerjaanPeer::getInstanceFromPool($key10);
                    if (!$obj10) {
                    ...
                    $obj10 = new $cls();
                    $obj10->hydrate($row, $startcol10);
                    PekerjaanPeer::addInstanceToPool($obj10, $key10);
                } // if $obj10 already loaded

                // Add the $obj1 (PesertaDidik) to the collection in $obj10 (Pekerjaan)
                $obj10->addPesertaDidikRelatedByPekerjaanIdAyah($obj1);

            } // if joined row is not null

                // Add objects for joined JenjangPendidikan rows

                $key11 = JenjangPendidikanPeer::getPrimaryKeyHashFromRow($row, $startcol11);
                if ($key11 !== null) {
                    $obj11 = JenjangPendidikanPeer::getInstanceFromPool($key11);
                    if (!$obj11) {
                    ...
                    $obj11 = new $cls();
                    $obj11->hydrate($row, $startcol11);
                    JenjangPendidikanPeer::addInstanceToPool($obj11, $key11);
                } // if $obj11 already loaded

                // Add the $obj1 (PesertaDidik) to the collection in $obj11 (JenjangPendidikan)
                $obj11->addPesertaDidikRelatedByJenjangPendidikanIbu($obj1);

            } // if joined row is not null

                // Add objects for joined Penghasilan rows

                $key12 = PenghasilanPeer::getPrimaryKeyHashFromRow($row, $startcol12);
                if ($key12 !== null) {
                    $obj12 = PenghasilanPeer::getInstanceFromPool($key12);
                    if (!$obj12) {
                    ...
                    $obj12 = new $cls();
                    $obj12->hydrate($row, $startcol12);
                    PenghasilanPeer::addInstanceToPool($obj12, $key12);
                } // if $obj12 already loaded

                // Add the $obj1 (PesertaDidik) to the collection in $obj12 (Penghasilan)
                $obj12->addPesertaDidikRelatedByPenghasilanIdWali($obj1);
                ...
                // Add the $obj1 (PesertaDidik) to the collection in $obj13 (Pekerjaan)
                $obj13->addPesertaDidikRelatedByPekerjaanIdIbu($obj1);
                ...
                // Add the $obj1 (PesertaDidik) to the collection in $obj14 (JenjangPendidikan)
                $obj14->addPesertaDidikRelatedByJenjangPendidikanAyah($obj1);
                ...
                // Add the $obj1 (PesertaDidik) to the collection in $obj15 (Penghasilan)
                $obj15->addPesertaDidikRelatedByPenghasilanIdIbu($obj1);
                ...
                // Add the $obj1 (PesertaDidik) to the collection in $obj16 (Pekerjaan)
                $obj16->addPesertaDidikRelatedByPekerjaanIdWali($obj1);
    ...
    public static function doSelectJoinAllExceptNegara(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        AgamaPeer::addSelectColumns($criteria);
        $startcol9 = $startcol8 + AgamaPeer::NUM_HYDRATE_COLUMNS;

        PenghasilanPeer::addSelectColumns($criteria);
        $startcol10 = $startcol9 + PenghasilanPeer::NUM_HYDRATE_COLUMNS;

        JenisTinggalPeer::addSelectColumns($criteria);
        $startcol11 = $startcol10 + JenisTinggalPeer::NUM_HYDRATE_COLUMNS;

        AlatTransportasiPeer::addSelectColumns($criteria);
        $startcol12 = $startcol11 + AlatTransportasiPeer::NUM_HYDRATE_COLUMNS;

        PekerjaanPeer::addSelectColumns($criteria);
        $startcol13 = $startcol12 + PekerjaanPeer::NUM_HYDRATE_COLUMNS;
        ...
        JenjangPendidikanPeer::addSelectColumns($criteria);
        $startcol20 = $startcol19 + JenjangPendidikanPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = PesertaDidikPeer::getInstanceFromPool($key1))) {
                ...
                $key8 = AgamaPeer::getPrimaryKeyHashFromRow($row, $startcol8);
                if ($key8 !== null) {
                    $obj8 = AgamaPeer::getInstanceFromPool($key8);
                    if (!$obj8) {
                    ...
                    $obj8 = new $cls();
                    $obj8->hydrate($row, $startcol8);
                    AgamaPeer::addInstanceToPool($obj8, $key8);
                } // if $obj8 already loaded

                // Add the $obj1 (PesertaDidik) to the collection in $obj8 (Agama)
                $obj8->addPesertaDidik($obj1);
                ...
                $key9 = PenghasilanPeer::getPrimaryKeyHashFromRow($row, $startcol9);
                if ($key9 !== null) {
                    $obj9 = PenghasilanPeer::getInstanceFromPool($key9);
                    if (!$obj9) {
                    ...
                    $obj9 = new $cls();
                    $obj9->hydrate($row, $startcol9);
                    PenghasilanPeer::addInstanceToPool($obj9, $key9);
                } // if $obj9 already loaded

                // Add the $obj1 (PesertaDidik) to the collection in $obj9 (Penghasilan)
                $obj9->addPesertaDidikRelatedByPenghasilanIdAyah($obj1);

            } // if joined row is not null

                // Add objects for joined JenisTinggal rows

                $key10 = JenisTinggalPeer::getPrimaryKeyHashFromRow($row, $startcol10);
                if ($key10 !== null) {
                    $obj10 = JenisTinggalPeer::getInstanceFromPool($key10);
                    if (!$obj10) {
                    ...
                    $obj10 = new $cls();
                    $obj10->hydrate($row, $startcol10);
                    JenisTinggalPeer::addInstanceToPool($obj10, $key10);
                } // if $obj10 already loaded

                // Add the $obj1 (PesertaDidik) to the collection in $obj10 (JenisTinggal)
                ...
                $key11 = AlatTransportasiPeer::getPrimaryKeyHashFromRow($row, $startcol11);
                if ($key11 !== null) {
                    $obj11 = AlatTransportasiPeer::getInstanceFromPool($key11);
                    if (!$obj11) {
                    ...
                    $obj11 = new $cls();
                    $obj11->hydrate($row, $startcol11);
                    AlatTransportasiPeer::addInstanceToPool($obj11, $key11);
                } // if $obj11 already loaded

                // Add the $obj1 (PesertaDidik) to the collection in $obj11 (AlatTransportasi)
                $obj11->addPesertaDidik($obj1);
                ...
                $key12 = PekerjaanPeer::getPrimaryKeyHashFromRow($row, $startcol12);
                if ($key12 !== null) {
                    $obj12 = PekerjaanPeer::getInstanceFromPool($key12);
                    if (!$obj12) {
                    ...
                    $obj12 = new $cls();
                    $obj12->hydrate($row, $startcol12);
                    PekerjaanPeer::addInstanceToPool($obj12, $key12);
                } // if $obj12 already loaded

                // Add the $obj1 (PesertaDidik) to the collection in $obj12 (Pekerjaan)
                $obj12->addPesertaDidikRelatedByPekerjaanIdAyah($obj1);
                ...
                $key19 = JenjangPendidikanPeer::getPrimaryKeyHashFromRow($row, $startcol19);
                if ($key19 !== null) {
                    $obj19 = JenjangPendidikanPeer::getInstanceFromPool($key19);
                    if (!$obj19) {
                    ...
                    $obj19 = new $cls();
                    $obj19->hydrate($row, $startcol19);
                    JenjangPendidikanPeer::addInstanceToPool($obj19, $key19);
                } // if $obj19 already loaded

                // Add the $obj1 (PesertaDidik) to the collection in $obj19 (JenjangPendidikan)
                $obj19->addPesertaDidikRelatedByJenjangPendidikanWali($obj1);
