...
/**
 * Base class that represents a row from the 'ref.agama' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseAgama extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\AgamaPeer';
    ...
    /**
     * Initializes internal state of BaseAgama object.
     * @see        applyDefaults()
     */
     ...
     * @return Agama The current object (for fluent API support)
     */
    public function setAgamaId($v)
    {
        ...
        if ($this->agama_id !== $v) {
            $this->agama_id = $v;
            $this->modifiedColumns[] = AgamaPeer::AGAMA_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = AgamaPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AgamaPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AgamaPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AgamaPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = AgamaPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->agama_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = AgamaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Agama object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AgamaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AgamaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AgamaPeer::AGAMA_ID)) {
            $modifiedColumns[':p' . $index++]  = '"agama_id"';
        }
        if ($this->isColumnModified(AgamaPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(AgamaPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(AgamaPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(AgamaPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(AgamaPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."agama" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AgamaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AgamaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Agama'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Agama'][$this->getPrimaryKey()] = true;
        $keys = AgamaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getAgamaId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setAgamaId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AgamaPeer::AGAMA_ID)) $criteria->add(AgamaPeer::AGAMA_ID, $this->agama_id);
        if ($this->isColumnModified(AgamaPeer::NAMA)) $criteria->add(AgamaPeer::NAMA, $this->nama);
        if ($this->isColumnModified(AgamaPeer::CREATE_DATE)) $criteria->add(AgamaPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(AgamaPeer::LAST_UPDATE)) $criteria->add(AgamaPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(AgamaPeer::EXPIRED_DATE)) $criteria->add(AgamaPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(AgamaPeer::LAST_SYNC)) $criteria->add(AgamaPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(AgamaPeer::DATABASE_NAME);
        $criteria->add(AgamaPeer::AGAMA_ID, $this->agama_id);
    ...
    /**
     * Generic method to set the primary key (agama_id column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of Agama (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setAgamaId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Agama Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Agama is new, it will return
    ...
    public function setPesertaDidiks(PropelCollection $pesertaDidiks, PropelPDO $con = null)
    {
        ...
        foreach ($pesertaDidiksToDelete as $pesertaDidikRemoved) {
            $pesertaDidikRemoved->setAgama(null);
        }
     ...
     * Otherwise if this Agama is new, it will return
     * an empty collection; or if this Agama has previously
     * been saved, it will retrieve related PesertaDidiks from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Agama.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(AgamaPeer::DEFAULT_STRING_FORMAT);
    }
