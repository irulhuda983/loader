...
abstract class BaseAlatLongitudinalQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "id_alat", "semester_id", "jumlah", "status_kelaikan", "create_date", "last_update", "soft_delete", "last_sync", "updater_id" FROM "alat_longitudinal" WHERE "id_alat" = :p0 AND "semester_id" = :p1';
        try {
