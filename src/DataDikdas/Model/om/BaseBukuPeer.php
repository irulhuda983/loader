...
abstract class BaseBukuPeer
{
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        BiblioPeer::addSelectColumns($criteria);
        $startcol8 = $startcol7 + BiblioPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key7 = BiblioPeer::getPrimaryKeyHashFromRow($row, $startcol7);
            if ($key7 !== null) {
                $obj7 = BiblioPeer::getInstanceFromPool($key7);
                if (!$obj7) {
                    ...
                    BiblioPeer::addInstanceToPool($obj7, $key7);
                } // if obj7 loaded

                // Add the $obj1 (Buku) to the collection in $obj7 (Biblio)
                $obj7->addBuku($obj1);
            } // if joined row not null
    ...
    public static function doSelectJoinAllExceptMataPelajaran(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        RuangPeer::addSelectColumns($criteria);
        $startcol6 = $startcol5 + RuangPeer::NUM_HYDRATE_COLUMNS;

        BiblioPeer::addSelectColumns($criteria);
        $startcol7 = $startcol6 + BiblioPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = BukuPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Buku) to the collection in $obj2 (Sekolah)
                $obj2->addBuku($obj1);
                ...
                // Add the $obj1 (Buku) to the collection in $obj3 (TingkatPendidikan)
                $obj3->addBuku($obj1);
                ...
                // Add the $obj1 (Buku) to the collection in $obj4 (JenisHapusBuku)
                $obj4->addBuku($obj1);
                ...
                $key5 = RuangPeer::getPrimaryKeyHashFromRow($row, $startcol5);
                if ($key5 !== null) {
                    $obj5 = RuangPeer::getInstanceFromPool($key5);
                    if (!$obj5) {
                    ...
                    $obj5 = new $cls();
                    $obj5->hydrate($row, $startcol5);
                    RuangPeer::addInstanceToPool($obj5, $key5);
                } // if $obj5 already loaded

                // Add the $obj1 (Buku) to the collection in $obj5 (Ruang)
                $obj5->addBuku($obj1);
                ...
                $key6 = BiblioPeer::getPrimaryKeyHashFromRow($row, $startcol6);
                if ($key6 !== null) {
                    $obj6 = BiblioPeer::getInstanceFromPool($key6);
                    if (!$obj6) {
                    ...
                    $obj6 = new $cls();
                    $obj6->hydrate($row, $startcol6);
                    BiblioPeer::addInstanceToPool($obj6, $key6);
                } // if $obj6 already loaded

                // Add the $obj1 (Buku) to the collection in $obj6 (Biblio)
                $obj6->addBuku($obj1);
