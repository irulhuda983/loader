...
abstract class BaseVldPesertaDidikQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "logid", "peserta_didik_id", "idtype", "status_validasi", "field_error", "error_message", "app_username", "create_date", "last_update", "soft_delete", "last_sync", "updater_id" FROM "vld_peserta_didik" WHERE "logid" = :p0';
        try {
