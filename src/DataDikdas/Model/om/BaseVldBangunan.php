...
/**
 * Base class that represents a row from the 'vld_bangunan' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldBangunan extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldBangunanPeer';
    ...
    /**
     * Initializes internal state of BaseVldBangunan object.
     * @see        applyDefaults()
     */
     ...
     * @return VldBangunan The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldBangunanPeer::LOGID;
        }
    ...
    public function setIdBangunan($v)
    {
        ...
        if ($this->id_bangunan !== $v) {
            $this->id_bangunan = $v;
            $this->modifiedColumns[] = VldBangunanPeer::ID_BANGUNAN;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldBangunanPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldBangunanPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldBangunanPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldBangunanPeer::ERROR_MESSAGE;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldBangunanPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldBangunanPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldBangunanPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldBangunanPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldBangunanPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldBangunanPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_bangunan = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            $this->app_username = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            ...
            return $startcol + 12; // 12 = VldBangunanPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldBangunan object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldBangunanPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldBangunanQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldBangunanPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldBangunanPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldBangunanPeer::ID_BANGUNAN)) {
            $modifiedColumns[':p' . $index++]  = '"id_bangunan"';
        }
        if ($this->isColumnModified(VldBangunanPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldBangunanPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldBangunanPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldBangunanPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldBangunanPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldBangunanPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldBangunanPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldBangunanPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldBangunanPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldBangunanPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_bangunan" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VldBangunanPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldBangunanPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldBangunan'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldBangunan'][$this->getPrimaryKey()] = true;
        $keys = VldBangunanPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getIdBangunan(),
            $keys[2] => $this->getIdtype(),
            $keys[3] => $this->getStatusValidasi(),
            $keys[4] => $this->getFieldError(),
            $keys[5] => $this->getErrorMessage(),
            $keys[6] => $this->getAppUsername(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setIdBangunan($arr[$keys[1]]);
        ...
        if (array_key_exists($keys[6], $arr)) $this->setAppUsername($arr[$keys[6]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldBangunanPeer::LOGID)) $criteria->add(VldBangunanPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldBangunanPeer::ID_BANGUNAN)) $criteria->add(VldBangunanPeer::ID_BANGUNAN, $this->id_bangunan);
        if ($this->isColumnModified(VldBangunanPeer::IDTYPE)) $criteria->add(VldBangunanPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldBangunanPeer::STATUS_VALIDASI)) $criteria->add(VldBangunanPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldBangunanPeer::FIELD_ERROR)) $criteria->add(VldBangunanPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldBangunanPeer::ERROR_MESSAGE)) $criteria->add(VldBangunanPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldBangunanPeer::APP_USERNAME)) $criteria->add(VldBangunanPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldBangunanPeer::CREATE_DATE)) $criteria->add(VldBangunanPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldBangunanPeer::LAST_UPDATE)) $criteria->add(VldBangunanPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldBangunanPeer::SOFT_DELETE)) $criteria->add(VldBangunanPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldBangunanPeer::LAST_SYNC)) $criteria->add(VldBangunanPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldBangunanPeer::UPDATER_ID)) $criteria->add(VldBangunanPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldBangunanPeer::DATABASE_NAME);
        $criteria->add(VldBangunanPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldBangunan (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldBangunan Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldBangunanPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldBangunanPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldBangunans($this);
             */
        }
    ...
    public function getBangunan(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBangunan === null && (($this->id_bangunan !== "" && $this->id_bangunan !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBangunan->addVldBangunans($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VldBangunanPeer::DEFAULT_STRING_FORMAT);
    }
