...
abstract class BaseVldAlatQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "logid", "id_alat", "idtype", "status_validasi", "field_error", "error_message", "app_username", "create_date", "last_update", "soft_delete", "last_sync", "updater_id" FROM "vld_alat" WHERE "logid" = :p0';
        try {
