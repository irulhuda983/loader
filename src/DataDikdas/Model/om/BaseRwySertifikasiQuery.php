...
abstract class BaseRwySertifikasiQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "riwayat_sertifikasi_id", "ptk_id", "bidang_studi_id", "id_jenis_sertifikasi", "tahun_sertifikasi", "nomor_sertifikat", "nrg", "nomor_peserta", "asal_data", "create_date", "last_update", "soft_delete", "last_sync", "updater_id" FROM "rwy_sertifikasi" WHERE "riwayat_sertifikasi_id" = :p0';
        try {
