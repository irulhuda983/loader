...
/**
 * Base class that represents a row from the 'vld_alat' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldAlat extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldAlatPeer';
    ...
    /**
     * Initializes internal state of BaseVldAlat object.
     * @see        applyDefaults()
     */
     ...
     * @return VldAlat The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldAlatPeer::LOGID;
        }
    ...
    public function setIdAlat($v)
    {
        ...
        if ($this->id_alat !== $v) {
            $this->id_alat = $v;
            $this->modifiedColumns[] = VldAlatPeer::ID_ALAT;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldAlatPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldAlatPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldAlatPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldAlatPeer::ERROR_MESSAGE;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldAlatPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldAlatPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldAlatPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldAlatPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldAlatPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldAlatPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_alat = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 12; // 12 = VldAlatPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldAlat object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldAlatPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldAlatQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldAlatPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldAlatPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldAlatPeer::ID_ALAT)) {
            $modifiedColumns[':p' . $index++]  = '"id_alat"';
        }
        if ($this->isColumnModified(VldAlatPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldAlatPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldAlatPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldAlatPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldAlatPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldAlatPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldAlatPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldAlatPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldAlatPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldAlatPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_alat" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VldAlatPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldAlatPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldAlat'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldAlat'][$this->getPrimaryKey()] = true;
        $keys = VldAlatPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getIdAlat(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setIdAlat($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldAlatPeer::LOGID)) $criteria->add(VldAlatPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldAlatPeer::ID_ALAT)) $criteria->add(VldAlatPeer::ID_ALAT, $this->id_alat);
        if ($this->isColumnModified(VldAlatPeer::IDTYPE)) $criteria->add(VldAlatPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldAlatPeer::STATUS_VALIDASI)) $criteria->add(VldAlatPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldAlatPeer::FIELD_ERROR)) $criteria->add(VldAlatPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldAlatPeer::ERROR_MESSAGE)) $criteria->add(VldAlatPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldAlatPeer::APP_USERNAME)) $criteria->add(VldAlatPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldAlatPeer::CREATE_DATE)) $criteria->add(VldAlatPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldAlatPeer::LAST_UPDATE)) $criteria->add(VldAlatPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldAlatPeer::SOFT_DELETE)) $criteria->add(VldAlatPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldAlatPeer::LAST_SYNC)) $criteria->add(VldAlatPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldAlatPeer::UPDATER_ID)) $criteria->add(VldAlatPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldAlatPeer::DATABASE_NAME);
        $criteria->add(VldAlatPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldAlat (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldAlat Clone of current object.
     * @throws PropelException
     */
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldAlats($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VldAlatPeer::DEFAULT_STRING_FORMAT);
    }
