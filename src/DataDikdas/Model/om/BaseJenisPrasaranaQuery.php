...
abstract class BaseJenisPrasaranaQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "jenis_prasarana_id", "nama", "a_unit_organisasi", "a_tanah", "a_bangunan", "a_ruang", "create_date", "last_update", "expired_date", "last_sync" FROM "ref"."jenis_prasarana" WHERE "jenis_prasarana_id" = :p0';
        try {
