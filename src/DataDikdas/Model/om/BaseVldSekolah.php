...
/**
 * Base class that represents a row from the 'vld_sekolah' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldSekolah extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldSekolahPeer';
    ...
    /**
     * Initializes internal state of BaseVldSekolah object.
     * @see        applyDefaults()
     */
     ...
     * @return VldSekolah The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldSekolahPeer::LOGID;
        }
    ...
    public function setSekolahId($v)
    {
        ...
        if ($this->sekolah_id !== $v) {
            $this->sekolah_id = $v;
            $this->modifiedColumns[] = VldSekolahPeer::SEKOLAH_ID;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldSekolahPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldSekolahPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldSekolahPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldSekolahPeer::ERROR_MESSAGE;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldSekolahPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldSekolahPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldSekolahPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldSekolahPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldSekolahPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldSekolahPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 12; // 12 = VldSekolahPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldSekolah object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldSekolahPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldSekolahQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldSekolahPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldSekolahPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldSekolahPeer::SEKOLAH_ID)) {
            $modifiedColumns[':p' . $index++]  = '"sekolah_id"';
        }
        if ($this->isColumnModified(VldSekolahPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldSekolahPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldSekolahPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldSekolahPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldSekolahPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldSekolahPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldSekolahPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldSekolahPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldSekolahPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldSekolahPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_sekolah" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VldSekolahPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldSekolahPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldSekolah'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldSekolah'][$this->getPrimaryKey()] = true;
        $keys = VldSekolahPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldSekolahPeer::LOGID)) $criteria->add(VldSekolahPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldSekolahPeer::SEKOLAH_ID)) $criteria->add(VldSekolahPeer::SEKOLAH_ID, $this->sekolah_id);
        if ($this->isColumnModified(VldSekolahPeer::IDTYPE)) $criteria->add(VldSekolahPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldSekolahPeer::STATUS_VALIDASI)) $criteria->add(VldSekolahPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldSekolahPeer::FIELD_ERROR)) $criteria->add(VldSekolahPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldSekolahPeer::ERROR_MESSAGE)) $criteria->add(VldSekolahPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldSekolahPeer::APP_USERNAME)) $criteria->add(VldSekolahPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldSekolahPeer::CREATE_DATE)) $criteria->add(VldSekolahPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldSekolahPeer::LAST_UPDATE)) $criteria->add(VldSekolahPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldSekolahPeer::SOFT_DELETE)) $criteria->add(VldSekolahPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldSekolahPeer::LAST_SYNC)) $criteria->add(VldSekolahPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldSekolahPeer::UPDATER_ID)) $criteria->add(VldSekolahPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldSekolahPeer::DATABASE_NAME);
        $criteria->add(VldSekolahPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldSekolah (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldSekolah Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldSekolahPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldSekolahPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldSekolahs($this);
             */
        }
    ...
    public function getSekolah(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSekolah === null && (($this->sekolah_id !== "" && $this->sekolah_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSekolah->addVldSekolahs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VldSekolahPeer::DEFAULT_STRING_FORMAT);
    }
