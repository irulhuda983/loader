...
abstract class BaseSanitasi extends BaseObject implements Persistent
{
     ...
     * Note: this column has a database default value of: '2020-04-22 21:16:13'
     * @var        string
     */
    ...
    public function applyDefaultValues()
    {
        ...
        $this->create_date = '2020-04-22 21:16:13';
        $this->last_update = '2020-04-22 21:16:13';
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                || ($dt->format('Y-m-d H:i:s') === '2020-04-22 21:16:13') // or the entered value matches the default
                 ) {
    ...
    public function hasOnlyDefaultValues()
    {
            ...
            if ($this->create_date !== '2020-04-22 21:16:13') {
                return false;
            }

            if ($this->last_update !== '2020-04-22 21:16:13') {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->ketersediaan_air = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->kecukupan_air = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->minum_siswa = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->memproses_air = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->siswa_bawa_air = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->toilet_siswa_laki = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->toilet_siswa_perempuan = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->toilet_siswa_kk = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->toilet_siswa_kecil = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->jml_jamban_l_g = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
            $this->jml_jamban_l_tg = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
            $this->jml_jamban_p_g = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
            $this->jml_jamban_p_tg = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
            $this->jml_jamban_lp_g = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
            $this->jml_jamban_lp_tg = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
            $this->tempat_cuci_tangan = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
            $this->tempat_cuci_tangan_rusak = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
            $this->a_sabun_air_mengalir = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
            $this->jamban_difabel = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
            $this->tipe_jamban = ($row[$startcol + 23] !== null) ? (string) $row[$startcol + 23] : null;
            $this->a_sedia_pembalut = ($row[$startcol + 24] !== null) ? (string) $row[$startcol + 24] : null;
            $this->kegiatan_cuci_tangan = ($row[$startcol + 25] !== null) ? (string) $row[$startcol + 25] : null;
            $this->pembuangan_air_limbah = ($row[$startcol + 26] !== null) ? (string) $row[$startcol + 26] : null;
            $this->a_kuras_septitank = ($row[$startcol + 27] !== null) ? (string) $row[$startcol + 27] : null;
            $this->a_memiliki_solokan = ($row[$startcol + 28] !== null) ? (string) $row[$startcol + 28] : null;
            $this->a_tempat_sampah_kelas = ($row[$startcol + 29] !== null) ? (string) $row[$startcol + 29] : null;
            $this->a_tempat_sampah_tutup_p = ($row[$startcol + 30] !== null) ? (string) $row[$startcol + 30] : null;
            $this->a_cermin_jamban_p = ($row[$startcol + 31] !== null) ? (string) $row[$startcol + 31] : null;
            $this->a_memiliki_tps = ($row[$startcol + 32] !== null) ? (string) $row[$startcol + 32] : null;
            $this->a_tps_angkut_rutin = ($row[$startcol + 33] !== null) ? (string) $row[$startcol + 33] : null;
            $this->a_anggaran_sanitasi = ($row[$startcol + 34] !== null) ? (string) $row[$startcol + 34] : null;
            $this->a_melibatkan_sanitasi_siswa = ($row[$startcol + 35] !== null) ? (string) $row[$startcol + 35] : null;
            $this->a_kemitraan_san_daerah = ($row[$startcol + 36] !== null) ? (string) $row[$startcol + 36] : null;
            $this->a_kemitraan_san_puskesmas = ($row[$startcol + 37] !== null) ? (string) $row[$startcol + 37] : null;
            $this->a_kemitraan_san_swasta = ($row[$startcol + 38] !== null) ? (string) $row[$startcol + 38] : null;
            $this->a_kemitraan_san_non_pem = ($row[$startcol + 39] !== null) ? (string) $row[$startcol + 39] : null;
            $this->kie_guru_cuci_tangan = ($row[$startcol + 40] !== null) ? (string) $row[$startcol + 40] : null;
            $this->kie_guru_haid = ($row[$startcol + 41] !== null) ? (string) $row[$startcol + 41] : null;
            $this->kie_guru_perawatan_toilet = ($row[$startcol + 42] !== null) ? (string) $row[$startcol + 42] : null;
            $this->kie_guru_keamanan_pangan = ($row[$startcol + 43] !== null) ? (string) $row[$startcol + 43] : null;
            $this->kie_guru_minum_air = ($row[$startcol + 44] !== null) ? (string) $row[$startcol + 44] : null;
            $this->kie_kelas_cuci_tangan = ($row[$startcol + 45] !== null) ? (string) $row[$startcol + 45] : null;
            $this->kie_kelas_haid = ($row[$startcol + 46] !== null) ? (string) $row[$startcol + 46] : null;
            $this->kie_kelas_perawatan_toilet = ($row[$startcol + 47] !== null) ? (string) $row[$startcol + 47] : null;
            $this->kie_kelas_keamanan_pangan = ($row[$startcol + 48] !== null) ? (string) $row[$startcol + 48] : null;
            $this->kie_kelas_minum_air = ($row[$startcol + 49] !== null) ? (string) $row[$startcol + 49] : null;
            $this->kie_toilet_cuci_tangan = ($row[$startcol + 50] !== null) ? (string) $row[$startcol + 50] : null;
            $this->kie_toilet_haid = ($row[$startcol + 51] !== null) ? (string) $row[$startcol + 51] : null;
            $this->kie_toilet_perawatan_toilet = ($row[$startcol + 52] !== null) ? (string) $row[$startcol + 52] : null;
            $this->kie_toilet_keamanan_pangan = ($row[$startcol + 53] !== null) ? (string) $row[$startcol + 53] : null;
            $this->kie_toilet_minum_air = ($row[$startcol + 54] !== null) ? (string) $row[$startcol + 54] : null;
            $this->kie_selasar_cuci_tangan = ($row[$startcol + 55] !== null) ? (string) $row[$startcol + 55] : null;
            $this->kie_selasar_haid = ($row[$startcol + 56] !== null) ? (string) $row[$startcol + 56] : null;
            $this->kie_selasar_perawatan_toilet = ($row[$startcol + 57] !== null) ? (string) $row[$startcol + 57] : null;
            $this->kie_selasar_keamanan_pangan = ($row[$startcol + 58] !== null) ? (string) $row[$startcol + 58] : null;
            $this->kie_selasar_minum_air = ($row[$startcol + 59] !== null) ? (string) $row[$startcol + 59] : null;
            $this->kie_uks_cuci_tangan = ($row[$startcol + 60] !== null) ? (string) $row[$startcol + 60] : null;
            $this->kie_uks_haid = ($row[$startcol + 61] !== null) ? (string) $row[$startcol + 61] : null;
            $this->kie_uks_perawatan_toilet = ($row[$startcol + 62] !== null) ? (string) $row[$startcol + 62] : null;
            $this->kie_uks_keamanan_pangan = ($row[$startcol + 63] !== null) ? (string) $row[$startcol + 63] : null;
            $this->kie_uks_minum_air = ($row[$startcol + 64] !== null) ? (string) $row[$startcol + 64] : null;
            $this->kie_kantin_cuci_tangan = ($row[$startcol + 65] !== null) ? (string) $row[$startcol + 65] : null;
            $this->kie_kantin_haid = ($row[$startcol + 66] !== null) ? (string) $row[$startcol + 66] : null;
            $this->kie_kantin_perawatan_toilet = ($row[$startcol + 67] !== null) ? (string) $row[$startcol + 67] : null;
            $this->kie_kantin_keamanan_pangan = ($row[$startcol + 68] !== null) ? (string) $row[$startcol + 68] : null;
            $this->kie_kantin_minum_air = ($row[$startcol + 69] !== null) ? (string) $row[$startcol + 69] : null;
            $this->create_date = ($row[$startcol + 70] !== null) ? (string) $row[$startcol + 70] : null;
            $this->last_update = ($row[$startcol + 71] !== null) ? (string) $row[$startcol + 71] : null;
            $this->soft_delete = ($row[$startcol + 72] !== null) ? (string) $row[$startcol + 72] : null;
            $this->last_sync = ($row[$startcol + 73] !== null) ? (string) $row[$startcol + 73] : null;
            $this->updater_id = ($row[$startcol + 74] !== null) ? (string) $row[$startcol + 74] : null;
            $this->resetModified();
    ...
    public function toArray($keyType = BasePeer::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[4] => $this->getKetersediaanAir(),
            $keys[5] => $this->getKecukupanAir(),
            $keys[6] => $this->getMinumSiswa(),
            $keys[7] => $this->getMemprosesAir(),
            $keys[8] => $this->getSiswaBawaAir(),
            $keys[9] => $this->getToiletSiswaLaki(),
            $keys[10] => $this->getToiletSiswaPerempuan(),
            $keys[11] => $this->getToiletSiswaKk(),
            $keys[12] => $this->getToiletSiswaKecil(),
            $keys[13] => $this->getJmlJambanLG(),
            $keys[14] => $this->getJmlJambanLTg(),
            $keys[15] => $this->getJmlJambanPG(),
            $keys[16] => $this->getJmlJambanPTg(),
            $keys[17] => $this->getJmlJambanLpG(),
            $keys[18] => $this->getJmlJambanLpTg(),
            $keys[19] => $this->getTempatCuciTangan(),
            $keys[20] => $this->getTempatCuciTanganRusak(),
            $keys[21] => $this->getASabunAirMengalir(),
            $keys[22] => $this->getJambanDifabel(),
            $keys[23] => $this->getTipeJamban(),
            $keys[24] => $this->getASediaPembalut(),
            $keys[25] => $this->getKegiatanCuciTangan(),
            $keys[26] => $this->getPembuanganAirLimbah(),
            $keys[27] => $this->getAKurasSeptitank(),
            $keys[28] => $this->getAMemilikiSolokan(),
            $keys[29] => $this->getATempatSampahKelas(),
            $keys[30] => $this->getATempatSampahTutupP(),
            $keys[31] => $this->getACerminJambanP(),
            $keys[32] => $this->getAMemilikiTps(),
            $keys[33] => $this->getATpsAngkutRutin(),
            $keys[34] => $this->getAAnggaranSanitasi(),
            $keys[35] => $this->getAMelibatkanSanitasiSiswa(),
            $keys[36] => $this->getAKemitraanSanDaerah(),
            $keys[37] => $this->getAKemitraanSanPuskesmas(),
            $keys[38] => $this->getAKemitraanSanSwasta(),
            $keys[39] => $this->getAKemitraanSanNonPem(),
            $keys[40] => $this->getKieGuruCuciTangan(),
            $keys[41] => $this->getKieGuruHaid(),
            $keys[42] => $this->getKieGuruPerawatanToilet(),
            $keys[43] => $this->getKieGuruKeamananPangan(),
            $keys[44] => $this->getKieGuruMinumAir(),
            $keys[45] => $this->getKieKelasCuciTangan(),
            $keys[46] => $this->getKieKelasHaid(),
            $keys[47] => $this->getKieKelasPerawatanToilet(),
            $keys[48] => $this->getKieKelasKeamananPangan(),
            $keys[49] => $this->getKieKelasMinumAir(),
            $keys[50] => $this->getKieToiletCuciTangan(),
            $keys[51] => $this->getKieToiletHaid(),
            $keys[52] => $this->getKieToiletPerawatanToilet(),
            $keys[53] => $this->getKieToiletKeamananPangan(),
            $keys[54] => $this->getKieToiletMinumAir(),
            $keys[55] => $this->getKieSelasarCuciTangan(),
            $keys[56] => $this->getKieSelasarHaid(),
            $keys[57] => $this->getKieSelasarPerawatanToilet(),
            $keys[58] => $this->getKieSelasarKeamananPangan(),
            $keys[59] => $this->getKieSelasarMinumAir(),
            $keys[60] => $this->getKieUksCuciTangan(),
            $keys[61] => $this->getKieUksHaid(),
            $keys[62] => $this->getKieUksPerawatanToilet(),
            $keys[63] => $this->getKieUksKeamananPangan(),
            $keys[64] => $this->getKieUksMinumAir(),
            $keys[65] => $this->getKieKantinCuciTangan(),
            $keys[66] => $this->getKieKantinHaid(),
            $keys[67] => $this->getKieKantinPerawatanToilet(),
            $keys[68] => $this->getKieKantinKeamananPangan(),
            $keys[69] => $this->getKieKantinMinumAir(),
            $keys[70] => $this->getCreateDate(),
            $keys[71] => $this->getLastUpdate(),
            $keys[72] => $this->getSoftDelete(),
            $keys[73] => $this->getLastSync(),
            $keys[74] => $this->getUpdaterId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setKetersediaanAir($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setKecukupanAir($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setMinumSiswa($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setMemprosesAir($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setSiswaBawaAir($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setToiletSiswaLaki($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setToiletSiswaPerempuan($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setToiletSiswaKk($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setToiletSiswaKecil($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setJmlJambanLG($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setJmlJambanLTg($arr[$keys[14]]);
        if (array_key_exists($keys[15], $arr)) $this->setJmlJambanPG($arr[$keys[15]]);
        if (array_key_exists($keys[16], $arr)) $this->setJmlJambanPTg($arr[$keys[16]]);
        if (array_key_exists($keys[17], $arr)) $this->setJmlJambanLpG($arr[$keys[17]]);
        if (array_key_exists($keys[18], $arr)) $this->setJmlJambanLpTg($arr[$keys[18]]);
        if (array_key_exists($keys[19], $arr)) $this->setTempatCuciTangan($arr[$keys[19]]);
        if (array_key_exists($keys[20], $arr)) $this->setTempatCuciTanganRusak($arr[$keys[20]]);
        if (array_key_exists($keys[21], $arr)) $this->setASabunAirMengalir($arr[$keys[21]]);
        if (array_key_exists($keys[22], $arr)) $this->setJambanDifabel($arr[$keys[22]]);
        if (array_key_exists($keys[23], $arr)) $this->setTipeJamban($arr[$keys[23]]);
        if (array_key_exists($keys[24], $arr)) $this->setASediaPembalut($arr[$keys[24]]);
        if (array_key_exists($keys[25], $arr)) $this->setKegiatanCuciTangan($arr[$keys[25]]);
        if (array_key_exists($keys[26], $arr)) $this->setPembuanganAirLimbah($arr[$keys[26]]);
        if (array_key_exists($keys[27], $arr)) $this->setAKurasSeptitank($arr[$keys[27]]);
        if (array_key_exists($keys[28], $arr)) $this->setAMemilikiSolokan($arr[$keys[28]]);
        if (array_key_exists($keys[29], $arr)) $this->setATempatSampahKelas($arr[$keys[29]]);
        if (array_key_exists($keys[30], $arr)) $this->setATempatSampahTutupP($arr[$keys[30]]);
        if (array_key_exists($keys[31], $arr)) $this->setACerminJambanP($arr[$keys[31]]);
        if (array_key_exists($keys[32], $arr)) $this->setAMemilikiTps($arr[$keys[32]]);
        if (array_key_exists($keys[33], $arr)) $this->setATpsAngkutRutin($arr[$keys[33]]);
        if (array_key_exists($keys[34], $arr)) $this->setAAnggaranSanitasi($arr[$keys[34]]);
        if (array_key_exists($keys[35], $arr)) $this->setAMelibatkanSanitasiSiswa($arr[$keys[35]]);
        if (array_key_exists($keys[36], $arr)) $this->setAKemitraanSanDaerah($arr[$keys[36]]);
        if (array_key_exists($keys[37], $arr)) $this->setAKemitraanSanPuskesmas($arr[$keys[37]]);
        if (array_key_exists($keys[38], $arr)) $this->setAKemitraanSanSwasta($arr[$keys[38]]);
        if (array_key_exists($keys[39], $arr)) $this->setAKemitraanSanNonPem($arr[$keys[39]]);
        if (array_key_exists($keys[40], $arr)) $this->setKieGuruCuciTangan($arr[$keys[40]]);
        if (array_key_exists($keys[41], $arr)) $this->setKieGuruHaid($arr[$keys[41]]);
        if (array_key_exists($keys[42], $arr)) $this->setKieGuruPerawatanToilet($arr[$keys[42]]);
        if (array_key_exists($keys[43], $arr)) $this->setKieGuruKeamananPangan($arr[$keys[43]]);
        if (array_key_exists($keys[44], $arr)) $this->setKieGuruMinumAir($arr[$keys[44]]);
        if (array_key_exists($keys[45], $arr)) $this->setKieKelasCuciTangan($arr[$keys[45]]);
        if (array_key_exists($keys[46], $arr)) $this->setKieKelasHaid($arr[$keys[46]]);
        if (array_key_exists($keys[47], $arr)) $this->setKieKelasPerawatanToilet($arr[$keys[47]]);
        if (array_key_exists($keys[48], $arr)) $this->setKieKelasKeamananPangan($arr[$keys[48]]);
        if (array_key_exists($keys[49], $arr)) $this->setKieKelasMinumAir($arr[$keys[49]]);
        if (array_key_exists($keys[50], $arr)) $this->setKieToiletCuciTangan($arr[$keys[50]]);
        if (array_key_exists($keys[51], $arr)) $this->setKieToiletHaid($arr[$keys[51]]);
        if (array_key_exists($keys[52], $arr)) $this->setKieToiletPerawatanToilet($arr[$keys[52]]);
        if (array_key_exists($keys[53], $arr)) $this->setKieToiletKeamananPangan($arr[$keys[53]]);
        if (array_key_exists($keys[54], $arr)) $this->setKieToiletMinumAir($arr[$keys[54]]);
        if (array_key_exists($keys[55], $arr)) $this->setKieSelasarCuciTangan($arr[$keys[55]]);
        if (array_key_exists($keys[56], $arr)) $this->setKieSelasarHaid($arr[$keys[56]]);
        if (array_key_exists($keys[57], $arr)) $this->setKieSelasarPerawatanToilet($arr[$keys[57]]);
        if (array_key_exists($keys[58], $arr)) $this->setKieSelasarKeamananPangan($arr[$keys[58]]);
        if (array_key_exists($keys[59], $arr)) $this->setKieSelasarMinumAir($arr[$keys[59]]);
        if (array_key_exists($keys[60], $arr)) $this->setKieUksCuciTangan($arr[$keys[60]]);
        if (array_key_exists($keys[61], $arr)) $this->setKieUksHaid($arr[$keys[61]]);
        if (array_key_exists($keys[62], $arr)) $this->setKieUksPerawatanToilet($arr[$keys[62]]);
        if (array_key_exists($keys[63], $arr)) $this->setKieUksKeamananPangan($arr[$keys[63]]);
        if (array_key_exists($keys[64], $arr)) $this->setKieUksMinumAir($arr[$keys[64]]);
        if (array_key_exists($keys[65], $arr)) $this->setKieKantinCuciTangan($arr[$keys[65]]);
        if (array_key_exists($keys[66], $arr)) $this->setKieKantinHaid($arr[$keys[66]]);
        if (array_key_exists($keys[67], $arr)) $this->setKieKantinPerawatanToilet($arr[$keys[67]]);
        if (array_key_exists($keys[68], $arr)) $this->setKieKantinKeamananPangan($arr[$keys[68]]);
        if (array_key_exists($keys[69], $arr)) $this->setKieKantinMinumAir($arr[$keys[69]]);
        if (array_key_exists($keys[70], $arr)) $this->setCreateDate($arr[$keys[70]]);
        if (array_key_exists($keys[71], $arr)) $this->setLastUpdate($arr[$keys[71]]);
        if (array_key_exists($keys[72], $arr)) $this->setSoftDelete($arr[$keys[72]]);
        if (array_key_exists($keys[73], $arr)) $this->setLastSync($arr[$keys[73]]);
        if (array_key_exists($keys[74], $arr)) $this->setUpdaterId($arr[$keys[74]]);
    }
