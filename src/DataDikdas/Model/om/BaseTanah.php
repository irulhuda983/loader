...
abstract class BaseTanah extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->tgl_mutasi_keluar = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
            $this->batas = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
            $this->ket_tanah = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
            $this->luas = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
            $this->luas_lahan_tersedia = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
            $this->no_sertifikat_tanah = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
            $this->asal_data = ($row[$startcol + 23] !== null) ? (string) $row[$startcol + 23] : null;
            ...
            return $startcol + 29; // 29 = TanahPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray($keyType = BasePeer::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[17] => $this->getTglMutasiKeluar(),
            $keys[18] => $this->getBatas(),
            $keys[19] => $this->getKetTanah(),
            $keys[20] => $this->getLuas(),
            $keys[21] => $this->getLuasLahanTersedia(),
            $keys[22] => $this->getNoSertifikatTanah(),
            $keys[23] => $this->getAsalData(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[17], $arr)) $this->setTglMutasiKeluar($arr[$keys[17]]);
        if (array_key_exists($keys[18], $arr)) $this->setBatas($arr[$keys[18]]);
        if (array_key_exists($keys[19], $arr)) $this->setKetTanah($arr[$keys[19]]);
        if (array_key_exists($keys[20], $arr)) $this->setLuas($arr[$keys[20]]);
        if (array_key_exists($keys[21], $arr)) $this->setLuasLahanTersedia($arr[$keys[21]]);
        if (array_key_exists($keys[22], $arr)) $this->setNoSertifikatTanah($arr[$keys[22]]);
        if (array_key_exists($keys[23], $arr)) $this->setAsalData($arr[$keys[23]]);
