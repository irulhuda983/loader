...
abstract class BaseRuang extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_bangunan = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->kd_ruang = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->nm_ruang = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->lantai = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->panjang = ($row[$startcol + 7] !== null) ? (double) $row[$startcol + 7] : null;
            $this->lebar = ($row[$startcol + 8] !== null) ? (double) $row[$startcol + 8] : null;
            $this->reg_pras = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->kapasitas = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->luas_ruang = ($row[$startcol + 11] !== null) ? (double) $row[$startcol + 11] : null;
            $this->luas_plester_m2 = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->luas_plafon_m2 = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
            $this->luas_dinding_m2 = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
            $this->luas_daun_jendela_m2 = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
            $this->luas_daun_pintu_m2 = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
            $this->panj_kusen_m = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
            $this->luas_tutup_lantai_m2 = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
            $this->panj_inst_listrik_m = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
            $this->jml_inst_listrik = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
            $this->panj_inst_air_m = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
            $this->jml_inst_air = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
            $this->panj_drainase_m = ($row[$startcol + 23] !== null) ? (string) $row[$startcol + 23] : null;
            $this->luas_finish_struktur_m2 = ($row[$startcol + 24] !== null) ? (string) $row[$startcol + 24] : null;
            $this->luas_finish_plafon_m2 = ($row[$startcol + 25] !== null) ? (string) $row[$startcol + 25] : null;
            $this->luas_finish_dinding_m2 = ($row[$startcol + 26] !== null) ? (string) $row[$startcol + 26] : null;
            $this->luas_finish_kpj_m2 = ($row[$startcol + 27] !== null) ? (string) $row[$startcol + 27] : null;
            $this->create_date = ($row[$startcol + 28] !== null) ? (string) $row[$startcol + 28] : null;
            $this->last_update = ($row[$startcol + 29] !== null) ? (string) $row[$startcol + 29] : null;
            $this->soft_delete = ($row[$startcol + 30] !== null) ? (string) $row[$startcol + 30] : null;
            $this->last_sync = ($row[$startcol + 31] !== null) ? (string) $row[$startcol + 31] : null;
            $this->updater_id = ($row[$startcol + 32] !== null) ? (string) $row[$startcol + 32] : null;
            $this->resetModified();
            ...
            return $startcol + 33; // 33 = RuangPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray($keyType = BasePeer::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getIdBangunan(),
            $keys[4] => $this->getKdRuang(),
            $keys[5] => $this->getNmRuang(),
            $keys[6] => $this->getLantai(),
            $keys[7] => $this->getPanjang(),
            $keys[8] => $this->getLebar(),
            $keys[9] => $this->getRegPras(),
            $keys[10] => $this->getKapasitas(),
            $keys[11] => $this->getLuasRuang(),
            $keys[12] => $this->getLuasPlesterM2(),
            $keys[13] => $this->getLuasPlafonM2(),
            $keys[14] => $this->getLuasDindingM2(),
            $keys[15] => $this->getLuasDaunJendelaM2(),
            $keys[16] => $this->getLuasDaunPintuM2(),
            $keys[17] => $this->getPanjKusenM(),
            $keys[18] => $this->getLuasTutupLantaiM2(),
            $keys[19] => $this->getPanjInstListrikM(),
            $keys[20] => $this->getJmlInstListrik(),
            $keys[21] => $this->getPanjInstAirM(),
            $keys[22] => $this->getJmlInstAir(),
            $keys[23] => $this->getPanjDrainaseM(),
            $keys[24] => $this->getLuasFinishStrukturM2(),
            $keys[25] => $this->getLuasFinishPlafonM2(),
            $keys[26] => $this->getLuasFinishDindingM2(),
            $keys[27] => $this->getLuasFinishKpjM2(),
            $keys[28] => $this->getCreateDate(),
            $keys[29] => $this->getLastUpdate(),
            $keys[30] => $this->getSoftDelete(),
            $keys[31] => $this->getLastSync(),
            $keys[32] => $this->getUpdaterId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setIdBangunan($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setKdRuang($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setNmRuang($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setLantai($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setPanjang($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setLebar($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setRegPras($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setKapasitas($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setLuasRuang($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setLuasPlesterM2($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setLuasPlafonM2($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setLuasDindingM2($arr[$keys[14]]);
        if (array_key_exists($keys[15], $arr)) $this->setLuasDaunJendelaM2($arr[$keys[15]]);
        if (array_key_exists($keys[16], $arr)) $this->setLuasDaunPintuM2($arr[$keys[16]]);
        if (array_key_exists($keys[17], $arr)) $this->setPanjKusenM($arr[$keys[17]]);
        if (array_key_exists($keys[18], $arr)) $this->setLuasTutupLantaiM2($arr[$keys[18]]);
        if (array_key_exists($keys[19], $arr)) $this->setPanjInstListrikM($arr[$keys[19]]);
        if (array_key_exists($keys[20], $arr)) $this->setJmlInstListrik($arr[$keys[20]]);
        if (array_key_exists($keys[21], $arr)) $this->setPanjInstAirM($arr[$keys[21]]);
        if (array_key_exists($keys[22], $arr)) $this->setJmlInstAir($arr[$keys[22]]);
        if (array_key_exists($keys[23], $arr)) $this->setPanjDrainaseM($arr[$keys[23]]);
        if (array_key_exists($keys[24], $arr)) $this->setLuasFinishStrukturM2($arr[$keys[24]]);
        if (array_key_exists($keys[25], $arr)) $this->setLuasFinishPlafonM2($arr[$keys[25]]);
        if (array_key_exists($keys[26], $arr)) $this->setLuasFinishDindingM2($arr[$keys[26]]);
        if (array_key_exists($keys[27], $arr)) $this->setLuasFinishKpjM2($arr[$keys[27]]);
        if (array_key_exists($keys[28], $arr)) $this->setCreateDate($arr[$keys[28]]);
        if (array_key_exists($keys[29], $arr)) $this->setLastUpdate($arr[$keys[29]]);
        if (array_key_exists($keys[30], $arr)) $this->setSoftDelete($arr[$keys[30]]);
        if (array_key_exists($keys[31], $arr)) $this->setLastSync($arr[$keys[31]]);
        if (array_key_exists($keys[32], $arr)) $this->setUpdaterId($arr[$keys[32]]);
    }
