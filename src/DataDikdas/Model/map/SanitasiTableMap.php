...
class SanitasiTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('create_date', 'CreateDate', 'TIMESTAMP', true, null, '2020-04-22 21:16:13.118438');
        $this->addColumn('last_update', 'LastUpdate', 'TIMESTAMP', true, null, '2020-04-22 21:16:13.118438');
