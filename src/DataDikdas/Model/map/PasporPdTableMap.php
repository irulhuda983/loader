...
/**
 * This class defines the structure of the 'paspor_pd' table.
 *
 *
 *
 ...
 */
class PasporPdTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.PasporPdTableMap';
    ...
    {
        // attributes
        $this->setName('paspor_pd');
        $this->setPhpName('PasporPd');
        $this->setClassname('DataDikdas\\Model\\PasporPd');
