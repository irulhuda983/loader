...
/**
 * This class defines the structure of the 'vld_alat' table.
 *
 *
 *
 ...
 */
class VldAlatTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldAlatTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('id_alat', 'IdAlat', 'VARCHAR', 'alat', 'id_alat', true, null, null);
