...
class JenisSaranaTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('spm_qty_min_per_siswa', 'SpmQtyMinPerSiswa', 'DECIMAL', true, 196609, 0);
        $this->addColumn('spm_qty_min_per_sekolah', 'SpmQtyMinPerSekolah', 'DECIMAL', true, 262144, 0);
